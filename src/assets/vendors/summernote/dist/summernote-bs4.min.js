...
!(function(a) {
    ...
    o = (function() {
      var b = function(b) {
        ...
        H = function(a) {
          var b = G(a);
          return (
            0 === b || ((!e(a) && 1 === b && a.innerHTML === F) || !(!m.all(a.childNodes, e) || '' !== a.innerHTML))
          );
        },
        I = function(a) {
    ...
    p = function(b, c) {
      ...
      return (
        ...
        (this.code = function(a) {
          ...
          if (void 0 === a)
            return this.invoke('codeview.sync'), c ? this.layoutInfo.codable.val() : this.layoutInfo.editable.html();
        ...
        (this.initializeModule = function(a) {
          ...
          (c.shouldInitialize = c.shouldInitialize || l.ok),
            c.shouldInitialize() && (c.initialize && c.initialize(), c.events && o.attachEvents(b, c.events));
        }),
        ...
        (this.removeModule = function(a) {
          var c = this.modules[a];
          c.shouldInitialize() && (c.events && o.detachEvents(b, c.events), c.destroy && c.destroy()),
  ...
  var q = function(b, c, d, e) {
        ...
        ? c.items
            .map(function(a) {
              var b = 'string' == typeof a ? a : a.value || '',
                d = c.template ? c.template(a) : a;
              return (
                '<a class="dropdown-item" href="#" data-value="' + b + '">' + I(c.checkClassName) + ' ' + d + '</a>'
              );
            })
            .join('')
        : c.items;
    ...
    E = r.create('<div class="note-color-palette"/>', function(a, b) {
      ...
      a.html(c.join('')),
        b.tooltip && a.find('.note-color-btn').tooltip({ container: 'body', trigger: 'hover', placement: 'bottom' });
    }),
    ...
    J = {
      ...
      button: function(a, b) {
        return r.create('<button type="button" class="note-btn btn btn-light btn-sm" tabindex="-1">', function(a, b) {
          b &&
            ...
            a.attr({ title: b.tooltip }).tooltip({ container: 'body', trigger: 'hover', placement: 'bottom' });
        })(a, b);
      },
      ...
      createLayout: function(a, b) {
        ...
        var c = (b.airMode
          ...
          : J.editor([J.toolbar(), J.editingArea([J.codable(), J.editable()]), J.statusbar()])
        ).render();
        return (
          c.insertAfter(a),
          {
        ...
        d = function(b, e, f, g) {
          ...
          (this.getPoints = function() {
            ...
            (this.scrollIntoView = function(b) {
              var c = a(b).height();
              return (
                b.scrollTop + c < this.sc.offsetTop && (b.scrollTop += Math.abs(b.scrollTop + c - this.sc.offsetTop)),
                this
              );
            }),
            (this.normalize = function() {
              var a = function(a, b) {
                  ...
                  if (
                    ((o.isLeftEdgePointOf(a, c) || o.isVoid(o.prevPoint(a).node)) && !b) ||
                    ((o.isRightEdgePointOf(a, c) || o.isVoid(o.nextPoint(a).node)) && b)
                  ) {
                    ...
                    if (!o.isEditable(b.node)) {
                      ...
                      d
                        ? (o.isLeftEdgePoint(b) && h.push(b.node),
                          o.isRightEdgePoint(b) && m.contains(h, b.node) && (e = b.node))
            ...
            (this.splitText = function() {
              ...
              return (
                ...
                o.isText(b) &&
                  ...
                  ((c.sc = b.splitText(e)), (c.so = 0), a && ((c.ec = c.sc), (c.eo = g - e))),
          ...
          (this.isOnEditable = i(o.isEditable)),
            ...
            (this.wrapBodyInlineWithPara = function() {
              if (o.isBodyContainer(b) && o.isEmpty(b))
                return (b.innerHTML = o.emptyPara), new d(b.firstChild, 0, b.firstChild, 0);
      ...
      return {
        create: function(a, b, c, e) {
          ...
          return f || 1 !== arguments.length
            ? f
            : ((f = this.createFromNode(arguments[0])), f.collapse(o.emptyPara === arguments[0].innerHTML));
        },
              ...
              var f = m.head(e),
                ...
                i =
                  h.childNodes.length > 1
                    ? o.splitTree(h, { node: g.parentNode, offset: o.position(g) + 1 }, { isSkipPaddingBlankHTML: !0 })
                    : null,
      ...
      function e() {
        return !a || !a.tagName || ('td' !== a.tagName.toLowerCase() && 'th' !== a.tagName.toLowerCase())
          ...
          : ((n.colPos = a.cellIndex),
            a.parentElement && a.parentElement.tagName && 'tr' === a.parentElement.tagName.toLowerCase()
              ? void (n.rowPos = a.parentElement.rowIndex)
              : void console.error('Impossible to identify start Row point.', a));
      }
  ...
  (R.where = { Row: 0, Column: 1 }),
    ...
    (R.resultAction = { Ignore: 0, SubtractSpanCount: 1, RemoveCell: 2, AddCell: 3, SumSpanCount: 4 });
  var S,
    T = function() {
      (this.tab = function(a, b) {
        ...
        (this.addCol = function(b, c) {
          ...
          a(e)
            ...
            .push(e);
          for (
            var f = new R(d, R.where.Column, R.requestAction.Add, a(e).closest('table')[0]),
              g = f.getActionList(),
              h = 0;
            h < g.length;
            h++
                ...
                case R.resultAction.SubtractSpanCount:
                  l &&
                    (m > 2
                      ...
                      : 2 === m &&
                        (j.removeAttribute('rowSpan'), k.rowIndex !== f && j.cellIndex === e && (j.innerHTML = '')));
                  continue;
              ...
              switch (g[h].action) {
                ...
                case R.resultAction.SubtractSpanCount:
                  ...
                  if (j) {
                    ...
                    k > 2
                      ? (k--, i.setAttribute('colSpan', k), i.cellIndex === e && (i.innerHTML = ''))
        ...
        f
          .on('keydown', function(a) {
            a.keyCode === K.code.ENTER && b.triggerEvent('enter', a),
              ...
              a.isDefaultPrevented() || (g.shortcuts ? c.handleKeyMap(a) : c.preventDefaultEditableShortCuts(a));
          })
          .on('keyup', function(a) {
      ...
      (this.fontSize = function(b) {
        ...
        (this.createLink = this.wrapCommand(function(b) {
          ...
          'string' == typeof c && (c = c.trim()),
            (c = g.onCreateLink ? g.onCreateLink(c) : /^[A-Za-z][A-Za-z0-9+-.]*\:[\/\/]?/.test(c) ? c : 'http://' + c);
          var i = [];
          if (h) {
            f = f.deleteContents();
      ...
      (this.events = {
        ...
        (this.pasteByHook = function() {
          ...
          if (o.isImg(c) && 0 === d.indexOf('data:')) {
            for (var e = atob(c.src.split(',')[1]), f = new Uint8Array(e.length), g = 0; g < e.length; g++)
              f[g] = e.charCodeAt(g);
    ...
    W = function(b) {
      var c = a(document),
        ...
        g = f.langInfo,
        h = {},
        i = a(['<div class="note-dropzone">', '  <div class="note-dropzone-message"/>', '</div>'].join('')).prependTo(
          d
        ),
        j = function() {
        ...
        (this.attachDragAndDropEvent = function() {
          ...
          (h.onDragenter = function(a) {
            ...
            c ||
              f.length ||
              !e ||
              (d.addClass('dragover'), i.width(d.width()), i.height(d.height()), j.text(g.image.dragImageHere)),
              (f = f.add(a.target));
          }),
            ...
            this.$handle.on('mousedown', function(a) {
              if (o.isControlSizing(a.target)) {
                ...
                var e = c.$handle.find('.note-control-selection').data('target'),
                  ...
                  g = d.scrollTop(),
                  h = function(a) {
                    b.invoke('editor.resizeTo', { x: a.clientX - f.left, y: a.clientY - (f.top - g) }, e, !a.shiftKey),
                      c.update(e[0]);
                  };
        ...
        (this.isFontInstalled = function(a) {
          return (
            c.fontInstalledMap.hasOwnProperty(a) ||
              (c.fontInstalledMap[a] = k.isFontInstalled(a) || m.contains(f.fontNamesIgnoreCheck, a)),
                    ...
                    d.dropdown({
                      ...
                      callback: function(b) {
                        b.find('.note-holder').each(function() {
                          var b = a(this);
                          b.append(
                            d.palette({ colors: f.colors, eventName: b.data('event'), tooltip: f.tooltip }).render()
                          );
                        });
                      },
                      click: function(c) {
            ...
            b.memo('button.paragraph', function() {
              return d
                .buttonGroup([
                  ...
                  d.dropdown([
                    d.buttonGroup({ className: 'note-align', children: [e, h, j, k] }),
          ...
          c =
            ...
            (f.disableLinkTarget
              ...
              : a('<div/>')
                  .append(
                    d
                      .checkbox({ id: 'sn-checkbox-open-in-new-window', text: g.link.openInNewWindow, checked: !0 })
                      .render()
                  )
                  .html()),
          h =
            ...
            '</button>';
        this.$dialog = d
          .dialog({ className: 'link-dialog', title: g.link.insert, fade: f.dialogsFade, body: c, footer: h })
          .render()
          .appendTo(b);
      }),
        (this.destroy = function() {
              ...
              d.onDialogShown(c.$dialog, function() {
                ...
                i.prop('checked', l),
                  h.one('click', function(b) {
                    b.preventDefault(),
                      a.resolve({ range: e.range, url: g.val(), text: f.val(), isNewWindow: i.is(':checked') }),
      ...
      (this.initialize = function() {
        ...
        var j =
          ...
          k =
            ...
            '</button>';
        this.$dialog = d
          .dialog({ title: g.image.insert, fade: f.dialogsFade, body: j, footer: k })
          .render()
          .appendTo(b);
      }),
        (this.destroy = function() {
      ...
      (this.initialize = function() {
        var b = f.dialogsInBody ? a(document.body) : e,
          ...
          h =
            ...
            '</button>';
        this.$dialog = d
          .dialog({ title: g.video.insert, fade: f.dialogsFade, body: c, footer: h })
          .render()
          .appendTo(b);
      }),
        (this.destroy = function() {
      ...
      (this.createShortCutList = function() {
        ...
        return Object.keys(c)
          .map(function(d) {
            ...
            return (
              f
                .append(a('<label><kbd>' + d + '</kdb></label>').css({ width: 180, 'margin-right': 10 }))
        ...
        (this.handleKeydown = function(a) {
          this.$popover.is(':visible') &&
            (a.keyCode === K.code.ENTER
              ...
              : a.keyCode === K.code.DOWN && (a.preventDefault(), this.moveDown()));
        }),
          ...
          if (m.contains([K.code.ENTER, K.code.UP, K.code.DOWN], a.keyCode)) {
            ...
            if (g.length && e) {
              ...
              h &&
                ...
                'top' === f
                  ? this.$popover.css({ left: h.left, top: h.top - this.$popover.outerHeight() - 5 })
