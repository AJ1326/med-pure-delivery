      ...
      return (
        a.add('directionality', function(a) {
            ...
            f.length &&
              ...
              b.each(f, function(a) {
                e.getParent(a.parentNode, "*[dir='" + c + "']", e.getRoot()) ||
                  (d != c ? e.setAttrib(a, 'dir', c) : e.setAttrib(a, 'dir', null));
              }),
              a.nodeChanged());
          }
          function d(a) {
          ...
          a.addCommand('mceDirectionLTR', function() {
            ...
            a.addButton('ltr', { title: 'Left to right', cmd: 'mceDirectionLTR', stateSelector: d('ltr') }),
            a.addButton('rtl', { title: 'Right to left', cmd: 'mceDirectionRTL', stateSelector: d('rtl') });
        }),
        function() {}
      );
    }),
