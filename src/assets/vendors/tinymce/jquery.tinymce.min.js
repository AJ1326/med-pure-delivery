  ...
  g('0', [], function() {
    return function(a) {
      function b() {
        ...
        f.each(['text', 'html', 'val'], function(a, g) {
          ...
          f.fn[g] = function(a) {
            ...
            if (a !== c) return b.call(g.filter(':tinymce'), a), i.apply(g.not(':tinymce'), arguments), g;
            var h = '',
              k = arguments;
            return (
                ...
                ? a !== c
                  ? ('string' == typeof a &&
                      b.filter(':tinymce').each(function(b, c) {
                        var e = d(c);
                        e && e.setContent(i ? a + e.getContent() : e.getContent() + a);
                      }),
          ...
          (f.fn.attr = function(a, g) {
            var i = this,
              j = arguments;
            if (!a || 'value' !== a || !e(i)) return g !== c ? h.attr.apply(i, j) : h.attr.apply(i, j);
            if (g !== c) return b.call(i.filter(':tinymce'), g), h.attr.apply(i.not(':tinymce'), j), i;
            var k = i[0],
              l = d(k);
      ...
      (f.fn.tinymce = function(a) {
                  ...
                  f.on('init', function() {
                    ...
                    m.css('visibility', ''),
                      h &&
                        ++d == c.length &&
                        ('string' == typeof b &&
                          ((a = b.indexOf('.') === -1 ? null : i().resolve(b.replace(/\.\w+$/, ''))),
                          (b = i().resolve(b))),
                        b.apply(a || i(), c));
                  }));
            }),
        ...
        if ((m.css('visibility', 'hidden'), g.tinymce || d || !(j = a.script_url))) 1 === d ? h.push(c) : c();
        else {
          (d = 1),
          ...
          (o.type = 'text/javascript'),
            (o.onload = o.onreadystatechange = function(b) {
              (b = b || window.event),
                2 === d ||
                  ('load' != b.type && !/complete|loaded/.test(o.readyState)) ||
