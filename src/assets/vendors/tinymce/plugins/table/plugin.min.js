  ...
  h('b', tinymce.util.Tools.resolve),
      ...
      var c = function(a, b, c) {
        ...
        e = function(a, b, e, f) {
          var g,
            ...
            i = 0,
            j = d(a, b, e);
          for (g = e; (f > 0 ? g < a.length : g >= 0) && ((h = c(a, b, g)), j === h.elm); g += f) i++;
          return i;
        },
        f = function(a, b, c) {
          for (var d, e = a[c], f = b; f < e.length; f++) if (((d = e[f]), d.real)) return d.elm;
          return null;
        },
        g = function(a, c) {
          for (var d, f = [], g = a[c], h = 0; h < g.length; h++)
            (d = g[h]),
              f.push({ elm: d.elm, above: e(a, h, c, -1) - 1, below: e(a, h, c, 1) - 1 }),
    ...
    g('6', ['4', '2', 'c', 'd'], function(a, b, c, d) {
      ...
      return function(h, i, j) {
                  ...
                  e(m(c, 'td,th'), function(a, c) {
                    ...
                    for (h = f(a, 'rowspan'), i = f(a, 'colspan'), g = d; g < d + h; g++)
                      for (Z[g] || (Z[g] = []), e = c; e < c + i; e++)
                        Z[g][e] = { part: b, real: g == d && e == c, elm: a, rowspan: h, colspan: i };
                    $ = Math.max($, c + 1);
                  });
              }),
                (a += d.length);
        ...
        function y(d) {
          ...
          return (
            h.settings.table_clone_elements !== !1 &&
              (i = a.makeMap(
                (h.settings.table_clone_elements || 'strong em b i span font h1 h2 h3 h4 h5 h6 p div').toUpperCase(),
                /[ ,]/
              )),
            a.walk(
              d,
              function(a) {
                ...
                if (3 == a.nodeType)
                  return (
                    e(ca.getParents(a.parentNode, null, d).reverse(), function(a) {
                      i[a.nodeName] && ((a = q(a, !1)), f ? c && c.appendChild(a) : (f = c = a), (c = a));
                    }),
                    c && (c.innerHTML = b.ie && b.ie < 10 ? '&nbsp;' : '<br data-mce-bogus="1" />'),
                    !1
                  );
              },
              'childNodes'
        ...
        function z() {
          ...
          return (
            ...
            0 === ca.select('tr', i).length
              ? (b.setStartBefore(i), b.setEndBefore(i), ba.setRng(b), void ca.remove(i))
              : (e(ca.select('thead,tbody,tfoot', i), function(a) {
                ...
                void (
                  ...
                  a && (ba.select(a[Math.min(a.length - 1, _.x)].elm, !0), ba.collapse(!0)))
                ))
          );
        }
        function A(a, b, c, d) {
          ...
          for (e = Z[b][a].elm.parentNode, g = 1; g <= c; g++)
            if ((e = ca.getNext(e, 'tr'))) {
              ...
              if (f == -1) for (h = 1; h <= d; h++) e.insertBefore(y(e.cells[0]), e.cells[0]);
            }
        }
        function B() {
          e(Z, function(a, b) {
            e(a, function(a, c) {
              ...
              if (u(a) && ((a = a.elm), (d = f(a, 'colspan')), (e = f(a, 'rowspan')), d > 1 || e > 1)) {
                for (g(a, 'rowSpan', 1), g(a, 'colSpan', 1), h = 0; h < d - 1; h++) ca.insertAfter(y(a), a);
                A(c, b, e - 1, d);
              }
            });
          });
        ...
        function C(a, b, c) {
          for (var d = [], e = 0; e < a.length; e++) (e < b || e > c) && d.push(a[e]);
          return d;
        }
        function D(b) {
        ...
        function H(b, c, d) {
          ...
          if (
            (b
              ? ((f = T(b)), (h = f.x), (i = f.y), (j = h + (c - 1)), (k = i + (d - 1)))
              : ((_ = aa = null),
                e(Z, function(a, b) {
                  e(a, function(a, c) {
              ...
              for (o(a), h = 0; h < n; h++)
                (j = a.cells[h]),
                  ...
                  k > 1 &&
                    (q--,
                    b + k > d.length
                      ? ((k = d.length - b), g(j, 'rowSpan', k), l.push(d.length - 1))
                      : l.push(b + k - 1)),
                  p(j);
              for (
                e(l, function(a) {
              ...
              for (j = b; j <= d; j++)
                (a = Z[l][j]),
                  a.real &&
                    ...
                    i && l + i > g && (g = l + i));
            for (k(), l = c; l <= g; l++)
              for (j = b; j <= f; j++) Z[l][j] && ca.setAttrib(Z[l][j].elm, 'data-mce-selected', '1');
          }
        }
        function X(a, b) {
          var c, d, e;
      ...
      return function(d, e) {
        function f(a) {
          (d.getBody().style.webkitUserSelect = ''),
            (a || p) && (d.$('td[data-mce-selected],th[data-mce-selected]').removeAttr('data-mce-selected'), (p = !1));
        }
        function g(a, b) {
        ...
        function h(b) {
          ...
          if (!m && !n && h !== l && ((l = h), k && j)) {
            ...
            if ((e(!0), g(k, f))) {
              b.preventDefault(),
                i || ((i = new a(d, k, j)), (d.getBody().style.webkitUserSelect = 'none')),
                i.setEndCell(f),
                (p = !0),
        ...
        (o.tableProps = function() {
          ...
          (o.table = function(e) {
            function j() {
              ...
              l(v, this),
                ...
                d.undoManager.transact(function() {
                  if (
                    (p || (p = d.plugins.table.insertTable(w.cols || 1, w.rows || 1)),
                    ...
                    if (
                      ...
                      u.push({ name: 'border-spacing', value: h(w.cellspacing) }),
                      n(v, p, u),
                      v.setAttribs(p, {
                  ...
                  v.getAttrib(p, 'width') && !d.settings.table_style_by_css
                    ...
                    !e &&
                      w.caption &&
                      ((e = v.create('caption')),
                      (e.innerHTML = b.ie ? '\xa0' : '<br data-mce-bogus="1"/>'),
            ...
            e === !0
              ? ((p = v.getParent(d.selection.getStart(), 'table')),
                p &&
                  ((w = {
                    ...
                    cellpadding:
                      v.getAttrib(p, 'data-mce-cell-padding') || v.getAttrib(p, 'cellpadding') || o(p, 'padding'),
              ...
              : ((q = { label: 'Cols', name: 'cols' }), (r = { label: 'Rows', name: 'rows' })),
              d.settings.table_class_list &&
                (w['class'] && (w['class'] = w['class'].replace(/\s*mce\-item\-table\s*/g, '')),
                (s = {
                  name: 'class',
                  type: 'listbox',
                  label: 'Class',
                ...
                items: [
                  {
                    ...
                    items:
                      d.settings.table_appearance_options !== !1
                        ...
                        : [q, r, { label: 'Width', name: 'width' }, { label: 'Height', name: 'height' }]
                  },
                  {
                    label: 'Alignment',
                    name: 'align',
          ...
          (o.cell = function() {
                ...
                d.undoManager.transact(function() {
                  c(s, function(a) {
                    b(a, 'scope', p.scope),
                      ...
                      p.type && a.nodeName.toLowerCase() !== p.type && (a = r.rename(a, p.type)),
                      1 === s.length && (i(a), j(a)),
            ...
            var o,
              ...
              s = [];
            if (
              ((s = d.dom.select('td[data-mce-selected],th[data-mce-selected]')),
              ...
              d.settings.table_cell_advtab !== !1
                ...
                : d.windowManager.open({ title: 'Cell properties', data: p, body: t, onsubmit: n });
            }
          }),
          (o.row = function() {
            function b(a, b, c) {
                  ...
                  c(u, function(c) {
                    b(c, 'scope', r.scope),
                      ...
                      a !== c.parentNode.nodeName.toLowerCase() &&
                        ...
                        (g = c.parentNode),
                        (j = t.select(a, f)[0]),
                        j || ((j = t.create(a)), f.firstChild ? f.insertBefore(j, f.firstChild) : f.appendChild(j)),
                        j.appendChild(c),
            ...
            (n = d.dom.getParent(d.selection.getStart(), 'table')),
              ...
              p &&
                (u.length > 1
                  ? (r = { height: '', scope: '', class: '', align: '', type: p.parentNode.nodeName.toLowerCase() })
                  : ((r = {
                ...
                d.settings.table_row_advtab !== !1
                  ? d.windowManager.open({
                      ...
                      data: r,
                      bodyType: 'tabpanel',
                      body: [{ title: 'General', type: 'form', items: s }, f(t)],
                      onsubmit: j
                    })
                  : d.windowManager.open({ title: 'Row properties', data: r, body: s, onsubmit: j }));
          });
      };
    }),
      ...
      return function(d) {
          ...
          return (
            a.each(b, function(b, d) {
              ...
              a.each(b.cells, function(a) {
                ...
                for (
                  var f = { element: a.element, colspan: a.colspan, rowspan: a.rowspan, rowIndex: d, colIndex: b },
                    h = 0;
                  h < a.colspan;
                  h++
                )
            ...
            { grid: { maxRows: i, maxCols: j }, getAt: d, getAllCells: e, getAllRows: f }
          );
        }
        function A(a, b) {
        ...
        function F(a, b, c, d) {
          ...
          if (e) e = { value: e, delta: 0 };
            ...
            for (var f = a.slice(0, b).reverse(), g = 0; g < f.length; g++) f[g] && (e = { value: f[g], delta: g + 1 });
          var h = a[b + 1];
        ...
        function j() {
          function a(a, b) {
            ...
            return (
              ...
              0 ===
                c.innerHTML.replace(/<(br|img|object|embed|input|textarea)[^>]*>/gi, '-').replace(/<[^>]+>/g, '').length
            );
          }
              ...
              if ((f = h.dom.getParent(h.selection.getStart(), 'table'))) {
                if (
                  ...
                  return (
                    ...
                    void (h.selection.isCollapsed() && j && h.dom.isEmpty(j) && (e.preventDefault(), c(j), b(j)))
                  );
                e.preventDefault(),
        ...
        function n() {
          var b = '\ufeff',
            ...
            i = function(a, c) {
              var d;
              (d = c
                ? h.dom.create('p', { 'data-mce-caret': 'after', 'data-mce-bogus': 'all' }, '<br data-mce-bogus="1">')
            ...
            j = function(a, d) {
              var e = a.lastChild,
                ...
                j = g.startContainer,
                k = g.startOffset;
              c(a) ? ((a.innerHTML = b), (j = a.lastChild), (k = 0)) : f(e) || i(a, h.dom.isBlock(e)),
            ...
            k = function(a) {
              ...
              b.commonAncestorContainer === a.parentNode &&
                ...
                (c.setStart(a, 0),
                1 === d.nodeType ? c.setEnd(a, a.childNodes.length) : c.setEnd(d, d.nodeValue.length),
                h.selection.setRng(c));
            };
          h.on('keydown', function(b) {
            if (!((b.keyCode !== a.DELETE && b.keyCode !== a.BACKSPACE) || b.isDefaultPrevented())) {
              ...
              d(e) &&
                (h.selection.isCollapsed()
                  ? (j(e), (c(e) || (b.keyCode === a.BACKSPACE && g(e))) && b.preventDefault())
                  : (k(e),
                    h.undoManager.transact(function() {
      ...
      function k(a) {
        ...
        function d(c, d) {
          ...
          for (g = '<table id="__mce"><tbody>', e = 0; e < d; e++) {
            for (g += '<tr>', f = 0; f < c; f++) g += '<td>' + (b.ie && b.ie < 10 ? '&nbsp;' : '<br>') + '</td>';
            g += '</tr>';
          }
          return (
            (g += '</tbody></table>'),
        ...
        function r() {
          a.addButton('tableprops', { title: 'Table properties', onclick: z.tableProps, icon: 'table' }),
            a.addButton('tabledelete', { title: 'Delete table', onclick: c('mceTableDelete') }),
            a.addButton('tablecellprops', { title: 'Cell properties', onclick: c('mceTableCellProps') }),
            a.addButton('tablemergecells', { title: 'Merge cells', onclick: c('mceTableMergeCells') }),
            a.addButton('tablesplitcells', { title: 'Split cell', onclick: c('mceTableSplitCells') }),
            a.addButton('tableinsertrowbefore', { title: 'Insert row before', onclick: c('mceTableInsertRowBefore') }),
            a.addButton('tableinsertrowafter', { title: 'Insert row after', onclick: c('mceTableInsertRowAfter') }),
            a.addButton('tabledeleterow', { title: 'Delete row', onclick: c('mceTableDeleteRow') }),
            a.addButton('tablerowprops', { title: 'Row properties', onclick: c('mceTableRowProps') }),
            a.addButton('tablecutrow', { title: 'Cut row', onclick: c('mceTableCutRow') }),
            a.addButton('tablecopyrow', { title: 'Copy row', onclick: c('mceTableCopyRow') }),
            a.addButton('tablepasterowbefore', { title: 'Paste row before', onclick: c('mceTablePasteRowBefore') }),
            a.addButton('tablepasterowafter', { title: 'Paste row after', onclick: c('mceTablePasteRowAfter') }),
            a.addButton('tableinsertcolbefore', {
              title: 'Insert column before',
              onclick: c('mceTableInsertColBefore')
            }),
            a.addButton('tableinsertcolafter', { title: 'Insert column after', onclick: c('mceTableInsertColAfter') }),
            a.addButton('tabledeletecol', { title: 'Delete column', onclick: c('mceTableDeleteCol') });
        }
        function s(b) {
        ...
        !a.settings.object_resizing ||
          ...
          (a.settings.object_resizing !== !0 && 'table' !== a.settings.object_resizing) ||
          (x = i(a)),
          a.settings.table_grid === !1
            ? a.addMenuItem('inserttable', { text: 'Table', icon: 'table', context: 'table', onclick: z.table })
            : a.addMenuItem('inserttable', {
                ...
                ariaHideMenu: !0,
                onclick: function(a) {
                  a.aria && (this.parent().hideAll(), a.stopImmediatePropagation(), z.table());
                },
                onshow: function() {
                ...
                menu: [
                  {
                    ...
                    onmousemove: function(a) {
                      ...
                      'A' == d.tagName.toUpperCase() &&
                        ...
                        (this.isRtl() || 'tl-tr' == this.parent().rel) && (b = 9 - b),
                        (b === this.lastX && c === this.lastY) ||
                          (q(b, c, a.control), (this.lastX = b), (this.lastY = c)));
                    },
                    onclick: function(b) {
                      var c = this;
          ...
          a.addMenuItem('cell', {
            ...
            context: 'table',
            menu: [
              { text: 'Cell properties', onclick: c('mceTableCellProps'), onPostRender: n },
              { text: 'Merge cells', onclick: c('mceTableMergeCells'), onPostRender: o },
              { text: 'Split cell', onclick: c('mceTableSplitCells'), onPostRender: n }
            ]
          }),
          a.addMenuItem('row', {
            text: 'Row',
            context: 'table',
            menu: [
              { text: 'Insert row before', onclick: c('mceTableInsertRowBefore'), onPostRender: n },
              { text: 'Insert row after', onclick: c('mceTableInsertRowAfter'), onPostRender: n },
              { text: 'Delete row', onclick: c('mceTableDeleteRow'), onPostRender: n },
              { text: 'Row properties', onclick: c('mceTableRowProps'), onPostRender: n },
              { text: '-' },
              { text: 'Cut row', onclick: c('mceTableCutRow'), onPostRender: n },
              { text: 'Copy row', onclick: c('mceTableCopyRow'), onPostRender: n },
              { text: 'Paste row before', onclick: c('mceTablePasteRowBefore'), onPostRender: n },
              { text: 'Paste row after', onclick: c('mceTablePasteRowAfter'), onPostRender: n }
            ]
          }),
          a.addMenuItem('column', {
            ...
            context: 'table',
            menu: [
              { text: 'Insert column before', onclick: c('mceTableInsertColBefore'), onPostRender: n },
              { text: 'Insert column after', onclick: c('mceTableInsertColAfter'), onPostRender: n },
              { text: 'Delete column', onclick: c('mceTableDeleteCol'), onPostRender: n }
            ]
          });
        var A = [];
        l('inserttable tableprops deletetable | cell row column'.split(' '), function(b) {
          '|' == b ? A.push({ text: '-' }) : A.push(a.menuItems[b]);
        }),
          a.addButton('table', { type: 'menubutton', title: 'Table', menu: A }),
          b.isIE ||
          ...
          a.on('PreInit', function() {
            a.serializer.addAttributeFilter('data-mce-cell-padding,data-mce-border,data-mce-border-color', function(
              a,
              b
            ) {
          ...
          l(
            {
              ...
              mceTableMergeCells: function(b) {
                ...
                (c = a.dom.getParent(a.selection.getStart(), 'th,td')),
                  a.dom.select('td[data-mce-selected],th[data-mce-selected]').length ? b.merge() : z.merge(b, c);
              },
            ...
            function(b, c) {
              a.addCommand(c, function() {
                var c = new f(a);
                c && (b(c), a.execCommand('mceRepaint'), y.cellSelection.clear());
              });
            }
          ),
          l(
