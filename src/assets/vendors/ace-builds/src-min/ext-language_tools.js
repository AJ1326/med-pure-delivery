  ...
  (function() {
    r.implement(this, i),
      (this.getTokenizer = function() {
        function e(e, t, n) {
          return (
            (e = e.substr(1)), /^\d+$/.test(e) && !n.inFormatString ? [{ tabstopId: parseInt(e, 10) }] : [{ text: e }]
          );
        }
        function t(e) {
          return '(?:[^\\\\' + e + ']|\\\\.)';
      ...
      (this.expandSnippetForSelection = function(e, t) {
        ...
        return (
          ...
          u
            ? t && t.dryRun
              ? !0
              : (e.session.doc.removeInLine(n.row, n.column - u.replaceBefore.length, n.column + u.replaceAfter.length),
      ...
      (this.register = function(e, t) {
        ...
        function a(e) {
          ...
          n[t].push(e),
            e.tabTrigger &&
              !e.trigger &&
              (!e.guard && /^\w/.test(e.tabTrigger) && (e.guard = '\\b'), (e.trigger = s.escapeRegExp(e.tabTrigger)));
        ...
        e.forEach(function(e, n) {
          ...
          for (var i = e.length; i--; ) {
            ...
            d(f.start, t),
              ...
              a.fmtString ? ((f.linked = !0), (r.hasLinkedRanges = !0)) : r.firstNonLinked || (r.firstNonLinked = f);
          }
    ...
    var r = e('../virtual_renderer').VirtualRenderer,
      ...
      l = function(e) {
        ...
        var h = function() {
          ...
          p = function(e, t) {
            e !== l.start.row &&
              ((l.start.row = l.end.row = e), t || n.session._emit('changeBackMarker'), n._emit('changeHoverMarker'));
          };
          ...
          (d.$tokenizeRow = function(e) {
            ...
            if (t.meta) {
              var a = n.renderer.$size.scrollerWidth / n.renderer.layerConfig.characterWidth,
                f = t.meta;
              f.length + t.caption.length > a - 2 && (f = f.substr(0, a - t.caption.length - 3) + '\u2026'),
        ...
        (this.filterCompletions = function(e, t) {
          ...
          e: for (var s = 0, o; (o = e[s]); s++) {
            ...
            if (this.exactMatch) {
              ...
              var p;
              if ((p = u.toLowerCase().indexOf(i)) > -1) for (var d = p; d < p + i.length; d++) f |= 1 << d;
              else
  ...
  define('ace/ext/language_tools', [
    ...
    var r = e('../snippets').snippetManager,
      ...
      l = {
        ...
        getDocTooltip: function(e) {
          e.type == 'snippet' &&
            !e.docHTML &&
            (e.docHTML = ['<b>', o.escapeHTML(e.caption), '</b>', '<hr></hr>', o.escapeHTML(e.snippet)].join(''));
        }
      },
      c = [l, a, f];
    ...
    e('../config').defineOptions(g.prototype, 'editor', {
      ...
      enableLiveAutocompletion: {
        set: function(e) {
          e
            ? (this.completers || (this.completers = Array.isArray(e) ? e : c), this.commands.on('afterExec', m))
