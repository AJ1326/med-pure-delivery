...
jsc*/
  ...
  define('tinymce.core.ui.Menu', ['global!tinymce.util.Tools.resolve'], function(resolve) {
  ...
  define('tinymce.plugins.contextmenu.RangePoint', ['ephox.katamari.api.Arr'], function(Arr) {
