        ...
        d.add('importcss', function(d) {
          ...
          function g(b) {
            ...
            if (e) {
              var f = c.skin_url;
              return (
                (f = f ? d.documentBaseURI.toAbsolute(f) : a.baseURL + '/skins/' + e),
                ...
                c[1]
                  ? ((b = { title: a }),
                    d.schema.getTextBlockElements()[f]
                      ...
                      ? (b.selector = f)
                      : (b.inline = f))
                  : c[2] && (b = { inline: 'span', title: a.substr(1), classes: g }),
                d.settings.importcss_merge_classes !== !1 ? (b.classes = g) : (b.attributes = { class: g }),
                b
              );
            }
          }
          ...
          d.on('renderFormatsMenu', function(a) {
              ...
              s = function(a, c) {
                if (n(a, c, f)) {
                  ...
                  if (g) {
                    ...
                    return (
                      d.formatter.register(h, g), e.extend({}, j.settings.itemDefaults, { text: g.title, format: h })
                    );
                  }
                }
                return null;
            ...
            d.settings.importcss_append || j.items().remove(),
              r(i(a.doc || d.getDoc(), h(c.importcss_file_filter)), function(a) {
