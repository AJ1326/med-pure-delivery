...
jsc*/
  ...
  define('tinymce.core.util.Color', ['global!tinymce.util.Tools.resolve'], function(resolve) {
   ...
   * @private
   */
  define('tinymce.plugins.colorpicker.Plugin', ['tinymce.core.PluginManager', 'tinymce.core.util.Color'], function(
    PluginManager,
    Color
  ) {
