...
jsc*/
  ...
  define('tinymce.core.ThemeManager', ['global!tinymce.util.Tools.resolve'], function(resolve) {
  ...
  define('tinymce.core.ui.Api', ['global!tinymce.util.Tools.resolve'], function(resolve) {
  ...
  define('tinymce.themes.inlite.alien.EditorSettings', ['tinymce.themes.inlite.alien.Type'], function(Type) {
  ...
  define('tinymce.themes.inlite.core.PredicateId', ['tinymce.core.util.Tools'], function(Tools) {
  ...
  define('tinymce.core.EditorManager', ['global!tinymce.util.Tools.resolve'], function(resolve) {
  ...
  define('tinymce.themes.inlite.core.SkinLoader', ['tinymce.core.EditorManager', 'tinymce.core.dom.DOMUtils'], function(
    EditorManager,
    DOMUtils
  ) {
  ...
  define('tinymce.core.dom.TreeWalker', ['global!tinymce.util.Tools.resolve'], function(resolve) {
  ...
  define('tinymce.themes.inlite.core.Layout', [
    ...
    var calcInsert = function(targetRect, contentAreaRect, panelRect) {
      return calcByPositions(['cr-cl', 'cl-cr'], ['bc-tc', 'bl-tl', 'br-tr'], targetRect, contentAreaRect, panelRect);
    };
  ...
  define('tinymce.themes.inlite.file.Conversions', ['tinymce.core.util.Promise'], function(Promise) {
  ...
  define('tinymce.themes.inlite.file.Picker', ['tinymce.core.util.Promise'], function(Promise) {
  ...
  define('tinymce.themes.inlite.Theme', [
    ...
    var overrideLinkShortcut = function(editor, panel) {
      ...
      editor.shortcuts.add('meta+k', '', function() {
        var toolbars = getToolbars(editor);
        var result = (result = Matcher.match(editor, [SelectionMatcher.textSelection('quicklink')]));
