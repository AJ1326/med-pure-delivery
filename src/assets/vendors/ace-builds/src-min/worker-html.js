    ...
    })(
      {
            ...
            (u.prototype._parseError = function(e, t) {
              ...
              (u.prototype.tokenize = function(e) {
                ...
                function d(e) {
                  ...
                  return (
                    n === '/'
                      ...
                      : (t._emitToken({ type: 'Characters', data: '<' }), e.unget(n), t.setState(f)),
                    !0
                  );
                }
                function v(e) {
                ...
                function m(e) {
                  ...
                  return (
                    s(i) && r
                      ? ((t._currentToken = { type: 'EndTag', name: this._temporaryBuffer, data: [], selfClosing: !1 }),
                        t.setState(q))
                      : i === '/' && r
                      ? ((t._currentToken = { type: 'EndTag', name: this._temporaryBuffer, data: [], selfClosing: !1 }),
                        t.setState(K))
                ...
                function g(e) {
                  ...
                  return (
                    n === '/'
                      ...
                      : (t._emitToken({ type: 'Characters', data: '<' }), e.unget(n), t.setState(c)),
                    !0
                  );
                }
                function y(e) {
                ...
                function w(e) {
                  ...
                  return (
                    n === '/'
                      ...
                      : (t._emitToken({ type: 'Characters', data: '<' }), e.unget(n), t.setState(p)),
                    !0
                  );
                }
                function E(e) {
                ...
                function S(e) {
                  ...
                  return (
                    s(r) && n
                      ? ((t._currentToken = { type: 'EndTag', name: 'script', data: [], selfClosing: !1 }),
                        t.setState(q))
                      : r === '/' && n
                      ? ((t._currentToken = { type: 'EndTag', name: 'script', data: [], selfClosing: !1 }),
                        t.setState(K))
                  ...
                  return (
                    n === '/'
                      ...
                      ? (t._emitToken({ type: 'Characters', data: '<' + n }),
                        ...
                        t.setState(M))
                      : (t._emitToken({ type: 'Characters', data: '<' }), e.unget(n), t.setState(N)),
                    !0
                  );
                }
                function A(e) {
                ...
                function M(e) {
                  ...
                  return (
                    s(n) || n === '/' || n === '>'
                      ? (t._emitToken({ type: 'Characters', data: n }),
                        this._temporaryBuffer.toLowerCase() === 'script' ? t.setState(_) : t.setState(N))
                      : o(n)
                      ? (t._emitToken({ type: 'Characters', data: n }), (this._temporaryBuffer += n), e.commit())
                ...
                function H(e) {
                  ...
                  return (
                    n === '/'
                      ? (t._emitToken({ type: 'Characters', data: '/' }), (this._temporaryBuffer = ''), t.setState(B))
                ...
                function B(e) {
                  ...
                  return (
                    s(n) || n === '/' || n === '>'
                      ? (t._emitToken({ type: 'Characters', data: n }),
                        this._temporaryBuffer.toLowerCase() === 'script' ? t.setState(N) : t.setState(_))
                      : o(n)
                      ? (t._emitToken({ type: 'Characters', data: n }), (this._temporaryBuffer += n), e.commit())
                      : (e.unget(n), t.setState(_)),
                    !0
                  ...
                  return (
                    i === r.EOF
                      ? (t._parseError('bare-less-than-sign-at-eof'),
                        ...
                        t.setState(n))
                      : o(i)
                      ? ((t._currentToken = { type: 'StartTag', name: i.toLowerCase(), data: [] }), t.setState(I))
                      : i === '!'
                      ? t.setState(G)
                      : i === '/'
                      ? t.setState(F)
                      ...
                      ? (t._parseError('expected-tag-name-but-got-right-bracket'),
                        ...
                        t.setState(n))
                      : i === '?'
                      ? (t._parseError('expected-tag-name-but-got-question-mark'), e.unget(i), t.setState(Q))
                  ...
                  return (
                    i === r.EOF
                      ? (t._parseError('expected-closing-tag-but-got-eof'),
                        ...
                        t.setState(n))
                      : o(i)
                      ? ((t._currentToken = { type: 'EndTag', name: i.toLowerCase(), data: [] }), t.setState(I))
                      : i === '>'
                      ? (t._parseError('expected-closing-tag-but-got-right-bracket'), t.setState(n))
                      : (t._parseError('expected-closing-tag-but-got-char', { data: i }), e.unget(i), t.setState(Q)),
                    !0
                  );
                }
                function I(e) {
                ...
                function q(e) {
                  ...
                  if (i === r.EOF) t._parseError('expected-attribute-name-but-got-eof'), e.unget(i), t.setState(n);
                    ...
                    if (s(i)) return !0;
                    o(i)
                      ? (t._currentToken.data.push({ nodeName: i.toLowerCase(), nodeValue: '' }), t.setState(R))
                      : i === '>'
                      ? t._emitCurrentToken()
                      : i === '/'
                      ? t.setState(K)
                ...
                function R(e) {
                  ...
                  i === r.EOF
                    ...
                    ? (t._parseError('invalid-character-in-attribute-name'),
                      ...
                      (u = !1))
                    : i === '\0'
                    ? (t._parseError('invalid-codepoint'), (t._currentAttribute().nodeName += '\ufffd'))
                ...
                function z(e) {
                  ...
                  if (i === r.EOF) t._parseError('expected-attribute-value-but-got-eof'), e.unget(i), t.setState(n);
                    ...
                    i === '"'
                      ...
                      ? t.setState(X)
                      : i === '>'
                      ? (t._parseError('expected-attribute-value-but-got-right-bracket'), t._emitCurrentToken())
                      : i === '=' || i === '<' || i === '`'
                ...
                function X(e) {
                  ...
                  return (
                    i === r.EOF
                      ? (t._parseError('eof-in-attribute-value-single-quote'), e.unget(i), t.setState(n))
                      : i === "'"
                      ? t.setState(J)
                      : i === '&'
                ...
                function V(e) {
                  ...
                  if (i === r.EOF) t._parseError('eof-after-attribute-value'), e.unget(i), t.setState(n);
                    ...
                    o === r.EOF && (t._parseError('eof-in-attribute-value-no-quotes'), t._emitCurrentToken()),
                      e.commit(),
                ...
                function J(e) {
                  ...
                  return (
                    i === r.EOF
                      ...
                      : i === '/'
                      ? t.setState(K)
                      : (t._parseError('unexpected-character-after-attribute-value'), e.unget(i), t.setState(q)),
                    !0
                  );
                }
                function K(e) {
                  ...
                  return (
                    i === r.EOF
                      ? (t._parseError('unexpected-eof-after-solidus-in-tag'), e.unget(i), t.setState(n))
                      : i === '>'
                      ? ((t._currentToken.selfClosing = !0), t.setState(n), t._emitCurrentToken())
                      : (t._parseError('unexpected-character-after-solidus-in-tag'), e.unget(i), t.setState(q)),
                    !0
                  );
                }
                function Q(e) {
                ...
                function G(e) {
                  ...
                  if (n === '--') (t._currentToken = { type: 'Comment', data: '' }), t.setState(Z);
                    ...
                    var i = e.shift(5);
                    if (i === r.EOF || n === r.EOF)
                      return t._parseError('expected-dashes-or-doctype'), t.setState(Q), e.unget(n), !0;
                    (n += i),
                ...
                function Z(e) {
                  ...
                  return (
                    i === r.EOF
                      ? (t._parseError('eof-in-comment'), t._emitToken(t._currentToken), e.unget(i), t.setState(n))
                      : i === '-'
                      ? t.setState(et)
                      : i === '>'
                      ? (t._parseError('incorrect-comment'), t._emitToken(t._currentToken), t.setState(n))
                      : i === '\0'
                ...
                function nt(e) {
                  ...
                  return (
                    i === r.EOF
                      ...
                      ? t.setState(rt)
                      : i === '\0'
                      ? (t._parseError('invalid-codepoint'), (t._currentToken.data += '-\ufffd'), t.setState(tt))
                ...
                function rt(e) {
                  ...
                  return (
                    i === r.EOF
                      ...
                      : i === '!'
                      ? (t._parseError('unexpected-bang-after-double-dash-in-comment'), t.setState(it))
                      : i === '-'
                      ? (t._parseError('unexpected-dash-after-double-dash-in-comment'), (t._currentToken.data += i))
                      : i === '\0'
                      ? (t._parseError('invalid-codepoint'), (t._currentToken.data += '--\ufffd'), t.setState(tt))
                      ...
                      : s(i) ||
                        (i === '>'
                          ? (t._parseError('expected-doctype-name-but-got-right-bracket'),
                            ...
                            t.setState(n),
                            t._emitCurrentToken())
                          : (o(i) && (i = i.toLowerCase()), (t._currentToken.name = i), t.setState(ut))),
                    !0
                  );
                }
                function ut(e) {
                  ...
                  if (i === r.EOF)
                    ...
                    if (i === '>') t.setState(n), t._emitCurrentToken();
                      ...
                      e.unget(i),
                        (t._currentToken.forceQuirks = !0),
                        i === r.EOF
                          ? (t._parseError('eof-in-doctype'), e.unget(i), t.setState(n), t._emitCurrentToken())
                          : (t._parseError('expected-space-or-right-bracket-in-doctype', { data: i }), t.setState(wt));
                    }
                  return !0;
                }
                function ft(e) {
                ...
                function pt(e) {
                  ...
                  return (
                    i === r.EOF
                      ...
                      ? (t.setState(n), t._emitCurrentToken())
                      : i === '"'
                      ? (t._parseError('unexpected-char-in-doctype'), (t._currentToken.systemId = ''), t.setState(gt))
                      : i === "'"
                      ? (t._parseError('unexpected-char-in-doctype'), (t._currentToken.systemId = ''), t.setState(yt))
                      : (t._parseError('unexpected-char-in-doctype'),
                        (t._currentToken.forceQuirks = !0),
                        t.setState(wt)),
                    !0
            ...
            (m.prototype.skipAtMostOneLeadingNewline = function() {
              ...
              (g.prototype.adoptionAgencyEndTag = function(e) {
                ...
                while (s++ < t) {
                  ...
                  if (!r || (this.openElements.contains(r) && !this.openElements.inScope(r.localName)))
                  ...
                  this.openElements.inScope(r.localName) || this.parseError('adoption-agency-4.4', { name: e }),
                    r != this.currentStackItem() && this.parseError('adoption-agency-1.3', { name: e });
                  ...
                  this.detachFromParent(h.node),
                    a.isFosterParenting() ? this.insertIntoFosterParent(h.node) : this.attachNode(h.node, a.node);
                  ...
                  this.reparentChildren(o.node, v),
                    ...
                    this.removeElementFromActiveFormattingElements(r),
                    this.activeFormattingElements.splice(Math.min(l, this.activeFormattingElements.length), 0, g),
                    this.openElements.remove(r),
                    this.openElements.elements.splice(this.openElements.elements.indexOf(o) + 1, 0, g);
                }
                return !0;
              }),
              ...
              (g.prototype.insertHtmlElement = function(e) {
                ...
                return (
                  ...
                  this.openElements.pushHtmlElement(new f('http://www.w3.org/1999/xhtml', 'html', e, t)),
                  t
                );
              }),
              ...
              (g.prototype.insertBodyElement = function(e) {
                ...
                return (
                  this.attachNode(t, this.openElements.top.node),
                  this.openElements.pushBodyElement(new f('http://www.w3.org/1999/xhtml', 'body', e, t)),
                  t
                );
              }),
                ...
                return (
                  e.forEach(function(e) {
                    (e.namespaceURI = 'http://www.w3.org/1998/Math/MathML'),
                      s.MATHMLAttributeMap[e.nodeName] && (e.nodeName = s.MATHMLAttributeMap[e.nodeName]);
                  }),
                  e
                );
              }),
        ...
        13: [
          function(e, t, n) {
            ...
            function f(e) {
              return (
                a(JSON.stringify(e.actual, u), 128) + ' ' + e.operator + ' ' + a(JSON.stringify(e.expected, u), 128)
              );
            }
