!(function() {
  ...
  h('3', tinymce.util.Tools.resolve),
    ...
    g('9', ['i'], function(a) {
      var b = a.mac ? '\u2318' : 'Ctrl',
        ...
        d = [
          ...
          { shortcut: 'Ctrl + Shift + P > Ctrl + Shift + P', action: 'Focus to contextual toolbar' },
          { shortcut: b + ' + K', action: 'Insert link (if link plugin activated)' },
          { shortcut: b + ' + S', action: 'Save (if save plugin activated)' },
          { shortcut: b + ' + F', action: 'Find (if searchreplace plugin activated)' }
        ];
      return { shortcuts: d };
    }),
    g('5', ['8', '9'], function(a, b) {
      var c = function() {
        var c = function(a) {
            return 'aria-label="Action: ' + a.action + ', Shortcut: ' + a.shortcut.replace(/Ctrl/g, 'Control') + '"';
          },
          d = a
      ...
      var g = function(a) {
          return c
            ...
            .fold(d.constant(a), function(a) {
              return e.supplant('<a href="${url}" target="_blank">${name}</a>', {
                name: a,
                url: 'https://www.tinymce.com/docs/plugins/' + a
              });
            });
        },
        h = function(a) {
          var c = b.mapToArray(a.plugins, function(a, b) {
            ...
            d = c.length,
            e = c.join('');
          return '<p><b>Plugins installed (' + d + '):</b></p><ul>' + e + '</ul>';
        },
        i = function(a) {
          return {
            type: 'container',
        ...
        j = function() {
          return {
            type: 'container',
            html:
              '<div style="padding: 10px; background: #e3e7f4; height: 100%;" data-mce-tabstop="1" tabindex="-1"><p><b>Premium plugins:</b></p><ul><li>PowerPaste</li><li>Spell Checker Pro</li><li>Accessibility Checker</li><li>Advanced Code Editor</li><li>Enhanced Media Embed</li><li>Link Checker</li></ul><br /><p style="float: right;"><a href="https://www.tinymce.com/pricing/" target="_blank">Learn more...</a></p></div>',
            flex: 1
          };
        },
        k = function(a) {
      ...
      var b = function(a, b) {
        ...
        c = function() {
          var c = b(a.majorVersion, a.minorVersion),
            d = '<a href="https://www.tinymce.com/docs/changelog/" target="_blank">TinyMCE ' + c + '</a>';
          return [
        ...
        return function() {
          a.windowManager.open({
            ...
            onPostRender: function() {
              ...
              a.innerHTML = '<img src="' + e + '/img/logo.png" alt="TinyMCE Logo" style="width: 200px">';
            }
          });
        };
      };
    ...
    g('0', ['1', '2'], function(a, b) {
      var c = function(a, c) {
        a.addButton('help', { icon: 'help', onclick: b.openDialog(a, c) }),
          a.addMenuItem('Help', { text: 'Help', icon: 'help', context: 'view', onclick: b.openDialog(a, c) }),
