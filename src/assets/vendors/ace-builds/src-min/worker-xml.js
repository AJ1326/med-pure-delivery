...
!(function(e) {
      ...
      for (;;) {
        ...
        switch (e.charAt(E + 1)) {
          case '/':
            ...
            var O = A.localNSMap;
            A.tagName != L &&
              i.fatalError('end tag name: ' + L + ' does not match the current start tagName: ' + A.tagName),
          ...
          default:
            try {
              ...
              !_.closed && w(e, k, _.tagName, d) && ((_.closed = !0), n.nbsp || i.warning('unclosed xml attribute')),
                y(_, r, p),
                _.uri === 'http://www.w3.org/1999/xhtml' && !_.closed ? (k = b(e, k, _.tagName, o, r)) : k++;
            } catch (B) {
          ...
          case '>':
            switch (m) {
              ...
              case a:
                m === a && (d = s),
                  m == l
                    ? (i.warning('attribute "' + d + '" missed quot(")!!'), n.add(s, d.replace(/&#?\w+;/g, r), t))
                    : (i.warning('attribute "' + d + '" missed value!! "' + d + '" instead!!'), n.add(d, d, t));
                break;
              case f:
        ...
        default:
          ...
          if (u > 1 && /!doctype/i.test(o[0][0])) {
            var a = o[1][0],
              ...
              c = o[u - 1];
            return (
              n.startDTD(a, f && f.replace(/^(['"])(.*?)\1$/, '$2'), l && l.replace(/^(['"])(.*?)\1$/, '$2')),
              n.endDTD(),
              c.index + c[0].length
            );
          }
  ...
  define('ace/mode/xml/dom', ['require', 'exports', 'module'], function(e, t, n) {
    ...
    function i(e, t) {
      ...
      i instanceof t || ((n.prototype = t.prototype), (n = new n()), r(i, n), (e.prototype = i = n)),
  ...
  define('ace/mode/xml/dom-parser', ['require', 'exports', 'module', 'ace/mode/xml/sax', 'ace/mode/xml/dom'], function(
    e,
    t,
    n
  ) {
