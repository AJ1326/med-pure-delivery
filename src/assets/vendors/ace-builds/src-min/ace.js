(function() {
      ...
      c = function(e, t) {
        ...
        var L = !1,
              ...
              v
                ...
                : p ||
                  (e.substring(0, 9) == h && e.length > h.length
                    ...
                    : e.charAt(e.length - 1) == h.charAt(0) && (e = e.slice(0, -1)),
                  e != h.charAt(0) && e.charAt(e.length - 1) == h.charAt(0) && (e = e.slice(0, -1)),
                  e && t.onTextInput(e)),
              p && (p = !1),
              L && (L = !1);
          },
          ...
          H = function(e) {
            var n = M(e);
            typeof n == 'string'
              ? (n && t.onPaste(n, e), i.isIE && setTimeout(x), r.preventDefault(e))
              : ((c.value = ''), (v = !0));
          };
        ...
        r.addListener(c, 'compositionstart', B),
          ...
          (this.moveToMouse = function(e, n) {
            g || (g = c.style.cssText),
              (c.style.cssText =
                (n ? 'z-index:100000;' : '') + 'height:' + c.style.height + ';' + (i.isIE ? 'opacity:0.1;' : ''));
      ...
      c = function(e, t) {
            ...
            if (t) {
              ...
              while (i && i.nodeType == 1)
                r.push(i),
                  ...
                  !i.parentElement && i.getRootNode ? (i = i.getRootNode().host) : (i = i.parentElement);
            }
        ...
        var A = !1,
          ...
          B = function(e) {
            var s = _(e);
            typeof s == 'string'
              ? (s && t.onPaste(s, e), i.isIE && setTimeout(T), r.preventDefault(e))
              : ((n.value = ''), (d = !0));
          };
        ...
        var j = function(e) {
          ...
          I = function(e) {
            ...
            (L = function(n) {
              return (
                s && clearTimeout(s), (n = n.replace(h, '')), n == r.lastValue ? '' : (r.lastValue && s && t.undo(), n)
              );
            }),
              t.onCompositionEnd(),
        ...
        r.addListener(n, 'compositionstart', j),
          ...
          (this.moveToMouse = function(e, o) {
            m || (m = n.style.cssText),
              (n.style.cssText =
                (o ? 'z-index:100000;' : '') + 'height:' + n.style.height + ';' + (i.isIE ? 'opacity:0.1;' : ''));
  ...
  define('ace/mouse/mouse_event', ['require', 'exports', 'module', 'ace/lib/event', 'ace/lib/useragent'], function(
    e,
    t,
    n
  ) {
  ...
  define('ace/mouse/dragdrop_handler', [
    ...
    function f(e) {
      ...
      function _(e) {
        ...
        var o = 'none';
        return (
          r && t.indexOf(i) >= 0 ? (o = 'copy') : n.indexOf(i) >= 0 ? (o = 'move') : t.indexOf(i) >= 0 && (o = 'copy'),
          o
        );
      }
      var t = e.editor,
      ...
      (this.onDragStart = function(e) {
        ...
        (this.onDragEnter = function(e) {
          ...
          return (
            (p = e.clientX), (d = e.clientY), h || k(), y++, (e.dataTransfer.dropEffect = b = _(e)), i.preventDefault(e)
          );
        }),
          ...
          var o = this,
            ...
            f = function(e) {
              n.off('beforeEndOperation', c),
                ...
                (o.state = ''),
                s.$keepTextAreaAtCursor == null && ((s.$keepTextAreaAtCursor = !0), s.$moveTextAreaToCursor()),
                (o.isMousePressed = !1),
  ...
  define('ace/keyboard/keybinding', ['require', 'exports', 'module', 'ace/lib/keys', 'ace/lib/event'], function(
    e,
    t,
    n
  ) {
        ...
        (this.updateRowLine = function(e, t) {
          ...
          this.line = this.line.replace(/\t|[\u1100-\u2029, \u202F-\uFFE6]/g, function(e, t) {
            return e === '	' || s.isFullWidth(e.charCodeAt(0))
              ? ((u = e === '	' ? s.getScreenTabSize(t + o) : 2), (o += u - 1), i.stringRepeat(r.DOT, u))
              : e;
          });
        }),
        ...
        (this.getSelections = function(e, t) {
          ...
          for (var p, d = 0; d < i.length; d++)
            (p = n.logicalFromVisual[d]),
              (s = i[d]),
              (l = p >= a && p < f),
              l && !c ? (h = o) : !l && c && u.push({ left: h, width: o - h }),
              (o += this.charWidths[s]),
              (c = l);
        ...
        (this.offsetToCol = function(e) {
          ...
          return (
            i > 0 && s[i - 1] % 2 !== 0 && s[i] % 2 === 0
              ...
              : (this.isRtlDir && i === s.length - 1 && o === 0 && s[i - 1] % 2 === 0) ||
                (!this.isRtlDir && i === 0 && s[i] % 2 !== 0)
              ? (t = 1 + this.bidiMap.logicalFromVisual[i])
              : (i > 0 && s[i - 1] % 2 !== 0 && o !== 0 && i--, (t = this.bidiMap.logicalFromVisual[i])),
            t + this.wrapIndent
          );
        });
    }.call(u.prototype),
    ...
    (function() {
      r.implement(this, s),
        ...
        (this.moveCursorLongWordLeft = function() {
          ...
          this.session.tokenRe.exec(s) && ((t -= this.session.tokenRe.lastIndex), (this.session.tokenRe.lastIndex = 0)),
            this.moveCursorTo(e, t);
        }),
  ...
  define('ace/mode/text', [
    ...
    (function() {
      (this.$defaultBehaviour = new s()),
        ...
        (this.nonTokenRe = new RegExp('^(?:[^' + o.wordChars + '\\$_]|\\s])+', 'g')),
  ...
  define('ace/search_highlight', ['require', 'exports', 'module', 'ace/lib/lang', 'ace/lib/oop', 'ace/range'], function(
    e,
    t,
    n
  ) {
        ...
        (this.$onChange = function(e) {
          ...
          if (e.action == 'insert') {
            ...
            for (; o < u; o++) {
              ...
              if (a.start.row < i || (a.start.row == i && a.start.column <= n.colum))
      ...
      (this.getFoldAt = function(e, t, n) {
        ...
        (this.getCommentFoldRange = function(e, t, n) {
          ...
          if (s && /^comment|string/.test(u)) {
            ...
            return (
              (f.end.row = i.getCurrentTokenRow()), (f.end.column = i.getCurrentTokenColumn() + s.value.length - 2), f
            );
          }
        }),
            ...
            for (var o = 0; o < e.length; o++) {
              ...
              n(u)
                ? ((i = u.start),
                  ...
                  (s = !0))
                : ((i = u.start), r.compare(i.row, i.column) == -1 && (r = l.fromPoints(u.start, u.start)), (s = !1));
            }
            return r;
          }),
          (this.replace = function(e, t) {
  ...
  define('ace/keyboard/hash_handler', ['require', 'exports', 'module', 'ace/lib/keys', 'ace/lib/useragent'], function(
    e,
    t,
    n
  ) {
        ...
        r.implement(this, d),
          ...
          (this.insert = function(e, t) {
            ...
            if (this.getBehavioursEnabled() && !t) {
              ...
              s &&
                (e !== s.text &&
                  (this.inVirtualSelectionMode || ((this.session.mergeUndoDeltas = !1), (this.mergeNextCommand = !1))),
                (e = s.text));
            }
      ...
      (this.addSession = function(e) {
        ...
        (this.add = function(e, t, n) {
          ...
          if (t === !1 || !this.lastDeltas)
            (this.lastDeltas = []), this.$undoStack.push(this.lastDeltas), (e.id = this.$rev = ++this.$maxRev);
        ...
        (this.undo = function(e, t) {
          ...
          var r = n.pop(),
            s = null;
          return (
            r && r.length && ((s = e.undoChanges(r, t)), this.$redoStack.push(r), this.$syncRev()),
            (this.$fromUndo = !1),
            s
          );
        }),
        ...
        (this.drawTextMarker = function(t, n, i, s, o) {
          ...
          for (; l <= f; l++)
            (v.start.row = v.end.row = l),
              (v.start.column = l == a ? n.start.column : u.getRowWrapIndent(l)),
              (v.end.column = p),
              (c = h),
              (h = p),
    ...
    (function() {
      r.implement(this, u),
        ...
        (this.onChangeTabSize = this.$computeTabString = function() {
          ...
          for (var n = 1; n < e + 1; n++)
            this.showInvisibles
              ? t.push("<span class='ace_invisible ace_invisible_tab'>" + s.stringRepeat(this.TAB_CHAR, n) + '</span>')
        ...
        (this.update = function(e) {
          ...
          for (;;) {
            ...
            if (i > r) break;
            this.$useLineGroups() &&
              t.push("<div class='ace_line_group' style='height:", e.lineHeight * this.session.getRowLength(i), "px'>"),
    ...
    (function() {
      (this.CHANGE_CURSOR = 1),
        ...
        (this.$moveTextAreaToCursor = function() {
          ...
          (r -= this.scrollLeft),
            r > this.$size.scrollerWidth - s && (r = this.$size.scrollerWidth - s),
            (r += this.gutterWidth),
            (e.height = i + 'px'),
            (e.width = s + 'px'),
        ...
        (this.$computeLayerConfig = function() {
          ...
          this.session.setScrollTop(Math.max(-h.top, Math.min(this.scrollTop, i - t.scrollerHeight + h.bottom))),
            this.session.setScrollLeft(
              Math.max(-h.left, Math.min(this.scrollLeft, s + 2 * this.$padding - t.scrollerWidth + h.right))
            );
  ...
  define('ace/commands/multi_select_commands', ['require', 'exports', 'module', 'ace/keyboard/hash_handler'], function(
    e,
    t,
    n
  ) {
  ...
  define('ace/line_widgets', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/dom', 'ace/range'], function(
    e,
    t,
    n
  ) {
    ...
    (function() {
      (this.getRowLength = function(e) {
        ...
        (this.addLineWidget = function(e) {
          ...
          t &&
            ((e.$oldWidget = t), t.el && t.el.parentNode && (t.el.parentNode.removeChild(t.el), (t._inDocument = !1))),
