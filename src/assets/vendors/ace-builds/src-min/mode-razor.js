  ...
  define('ace/mode/razor_highlight_rules', [
        ...
        (this.$rules[t] = i.deepCopy(this.$rules.start)),
          this.$rules[t].unshift({
            ...
            onMatch: function(t, r, i) {
              ...
              return n[s] !== t
                ? 'invalid.illegal'
                : (i.shift(), i.shift(), (this.next = e(t, i[0]) || 'start'), 'paren.rparen');
            }
          });
      };
    r.inherits(f, u);
    var l = function() {
      ...
      var e = {
          ...
          onMatch: function(e, t, n) {
            return (
              n.unshift(e), n.unshift('razor-block-start'), (this.next = 'razor-block-start'), 'punctuation.block.razor'
            );
          }
        },
        t = { '@{': '}', '@(': ')', '@functions{': '}' },
        n = {
          ...
          onMatch: function(e, n, r) {
            ...
            return t[i] !== e
              ? 'invalid.illegal'
              : (r.shift(), r.shift(), (this.next = r.shift() || 'start'), 'punctuation.block.razor');
          }
        },
        r = {
          regex: '@(?![{(])',
        ...
        u = [
          { start: '@\\*', end: '\\*@', token: 'comment' },
          { token: ['meta.directive.razor', 'text', 'identifier'], regex: '^(\\s*@model)(\\s+)(.+)$' },
          e,
          r
        ];
