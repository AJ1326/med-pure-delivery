...
jsc*/
  ...
  define('tinymce.plugins.wordcount.text.WordBoundary', ['tinymce.plugins.wordcount.text.UnicodeData'], function(
    UnicodeData
  ) {
    ...
    var isWordBoundary = function(map, index) {
      ...
      if (
        (type === ci.MIDLETTER || type === ci.MIDNUMLET || nextType === ci.AT) &&
        nextType === ci.ALETTER &&
        prevType === ci.ALETTER
      ) {
        return false;
