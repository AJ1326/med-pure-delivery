define('ace/mode/doc_comment_highlight_rules', [
  ...
  define('ace/mode/mask_highlight_rules', [
    ...
    function N() {
      ...
      function s(t, n, r, i, s) {
        var o = 'pop',
          u = i || ['start'];
        u.length === 0 && (u = null),
          /block|multiline/.test(n) && ((o = n + 'end'), (e.$rules[o] = [k('empty', '', 'start')])),
          e.embedRules(t, n, [k(s || w, r, o)], u, u == null ? !0 : !1);
      }
      this.$rules = {
        start: [
          k('comment', '\\/\\/.*$'),
          k('comment', '\\/\\*', [k('comment', '.*?\\*\\/', 'start'), k('comment', '.+')]),
          C.string("'''"),
          C.string('"""'),
          C.string('"'),
          C.string("'"),
    ...
    function k(e, t, n) {
      var r, i, s;
      return (
        arguments.length === 4 ? ((r = n), (i = arguments[3])) : typeof n == 'string' ? (i = n) : (r = n),
    ...
    (function() {
      (E = i.arrayToMap('log'.split('|'))),
        (x = i.arrayToMap(':dualbind|:bind|:import|slot|event|style|html|markdown|md'.split('|'))),
        (S = i.arrayToMap(
    ...
    var C = {
      string: function(e, t) {
        var n = k(
          'string.start',
          e,
          [k(b + '.' + g, /~\[/, C.interpolation()), k('string.end', e, 'pop'), { defaultToken: 'string' }],
          t
        );
        if (e.length === 1) {
