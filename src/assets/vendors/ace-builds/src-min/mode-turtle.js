define('ace/mode/turtle_highlight_rules', [
  ...
  var r = e('../lib/oop'),
    ...
    s = function() {
      (this.$rules = {
        ...
        '#comments': [
          { token: ['punctuation.definition.comment.turtle', 'comment.line.hash.turtle'], regex: /(#)(.*$)/ }
        ],
        ...
        '#qnames': [
          { token: 'entity.name.other.qname.turtle', regex: /(?:[a-zA-Z][-_a-zA-Z0-9]*)?:(?:[_a-zA-Z][-_a-zA-Z0-9]*)?/ }
        ],
        '#rdf-schema-types': [
          { token: 'support.type.datatype.rdf.schema.turtle', regex: /rdfs?:[a-zA-Z]+|(?:^|\s)a(?:\s|$)/ }
        ],
        '#relative-urls': [
          {
            ...
            regex: /</,
            push: [
              { token: 'string.quoted.other.relative.url.turtle', regex: />/, next: 'pop' },
        ...
        '#strings': [
          {
            ...
            regex: /"""/,
            push: [
              { token: 'string.quoted.triple.turtle', regex: /"""/, next: 'pop' },
          ...
          },
          {
            ...
            regex: /"/,
            push: [
              { token: 'string.quoted.double.turtle', regex: /"/, next: 'pop' },
  ...
  (s.metaData = { fileTypes: ['ttl', 'nt'], name: 'Turtle', scopeName: 'source.turtle' }),
    r.inherits(s, i),
