        ...
        start: [
          {
            ...
            regex: /#/,
            push: [
              { token: 'comment.line.number-sign.bro', regex: /$/, next: 'pop' },
          ...
          },
          {
            ...
            regex: /"/,
            push: [
              { token: 'punctuation.definition.string.end.bro', regex: /"/, next: 'pop' },
        ...
        '#preprocessor-rule-other': [
          {
            ...
            regex: /^(\s*)(@if)((?:n?def)?)\b(.*?)(?:(?=)|$)/,
            push: [
              { token: ['text', 'meta.preprocessor.bro', 'text'], regex: /^(\s*)(@endif)\b(.*$)/, next: 'pop' },
              { include: '$base' }
            ]
          }
        ],
