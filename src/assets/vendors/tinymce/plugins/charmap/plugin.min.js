    ...
    g('0', ['1', '2'], function(a, b) {
      return (
        a.add('charmap', function(a) {
          ...
          function f(b) {
            var c = a.settings;
            return c.charmap && (b = e(c.charmap)), c.charmap_append ? [].concat(b).concat(e(c.charmap_append)) : b;
          }
          function g() {
            return f(c());
          }
            ...
            var o = {
              ...
              onclick: function(a) {
                ...
                if (/^(TD|DIV)$/.test(c.nodeName)) {
                  ...
                  d && d.hasAttribute('data-chr') && (h(d.getAttribute('data-chr')), a.ctrlKey || f.close());
                }
              },
              onmouseover: function(a) {
                var c = b(a.target);
                c && c.firstChild
                  ? (f.find('#preview').text(c.firstChild.firstChild.data), f.find('#previewTitle').text(c.title))
                  : (f.find('#preview').text(' '), f.find('#previewTitle').text(' '));
              }
            };
          ...
          return (
            ...
            a.addButton('charmap', { icon: 'charmap', tooltip: 'Special character', cmd: 'mceShowCharmap' }),
