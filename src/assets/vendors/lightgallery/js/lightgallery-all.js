  ...
  (function() {
    ...
    */
    ...
    Plugin.prototype.destroy = function(d) {
      ...
      // Distroy all lightGallery dummydataTable
      $.each($.fn.lightGallery.modules, function(key) {
...
(function(root, factory) {
  ...
  (function() {
    ...
    Autoplay.prototype.startlAuto = function() {
      ...
      _this.core.$outer
        .find('.lg-progress')
        .css('transition', 'width ' + (_this.core.s.speed + _this.core.s.pause) + 'ms ease 0s');
...
(function(root, factory) {
  ...
  (function() {
    ...
    Zoom.prototype.touchendZoom = function(startCoords, endCoords, allowX, allowY) {
      ...
      var maxX = Math.abs(
        $image.prop('offsetWidth') * Math.abs($image.attr('data-scale')) - _this.core.$outer.find('.lg').width() + minX
      );
      ...
      _this.core.$el.on('onAfterSlide.lg.tm', function(event, prevIndex, index) {
        if (history.replaceState) {
          history.replaceState(
            null,
            null,
            window.location.pathname + window.location.search + '#lg=' + _this.core.s.galleryId + '&slide=' + index
          );
        } else {
        ...
        setTimeout(function() {
          $('#lg-share-facebook').attr(
            ...
            'https://www.facebook.com/sharer/sharer.php?u=' +
              encodeURIComponent(_this.getSahreProps(index, 'facebookShareUrl') || window.location.href)
          );
          ...
          $('#lg-share-googleplus').attr(
            ...
            'https://plus.google.com/share?url=' +
              encodeURIComponent(_this.getSahreProps(index, 'googleplusShareUrl') || window.location.href)
          );
