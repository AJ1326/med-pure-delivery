!(function() {
  ...
  h('6', tinymce.util.Tools.resolve),
    ...
    g('j', ['e'], function(a) {
      var b = function(b) {
        return '<span data-mce-bogus="1" class="mce-' + a.charMap[b] + '">' + b + '</span>';
      };
      return { wrapCharWithSpan: b };
    }),
    g('f', ['3', '4', 'g', 'e', 'j'], function(a, b, c, d, e) {
      var f = function(a) {
          return c.isText(a) && void 0 !== c.value(a) && d.regExp.test(c.value(a));
        },
        g = function(c, d) {
          var e = [],
            f = c.dom(),
      ...
      return { isMatch: f, filterDescendants: g, findParentElm: h, replaceWithSpans: i };
    }),
    g('5', ['e', 'f', '3', '4', 'g'], function(a, b, c, d, e) {
      var f = function(a, f) {
          ...
          c.each(i, function(c) {
            ...
            for (h = a.dom.create('div', null, d); (g = h.lastChild); ) a.dom.insertAfter(g, c.dom());
            a.dom.remove(c.dom());
          });
        },
        g = function(b, d) {
        ...
        h = function(a) {
          ...
          (e = void 0 !== e ? e : c), g(a, e), f(a, e), a.selection.moveToBookmark(d);
        };
      ...
      return (
        a.add('visualchars', function(a) {
          ...
          a.settings.forced_root_block !== !1 &&
            ...
            a.addButton('visualchars', { title: 'Show invisible characters', cmd: 'mceVisualChars', onPostRender: f }),
