...
(function(factory) {
  ...
  var Context = function($note, options) {
    ...
    /**
     * create layout and initialize dummydataTable and other resources
     */
    ...
    /**
     * destroy dummydataTable and other resources and remove layout
     */
    ...
    /**
     * destory dummydataTable and other resources and initialize it again
     */
    this.reset = function() {
    ...
    this._initialize = function() {
      ...
      // add and initialize dummydataTable
    ...
    this._destroy = function() {
      // destroy dummydataTable with reversed order
    ...
    var markup = $.isArray(options.items)
      ? options.items
          .map(function(item) {
            ...
            var content = options.template ? options.template(item) : item;
            return (
              '<li><a href="#" data-value="' + value + '">' + icon(options.checkClassName) + ' ' + content + '</a></li>'
            );
          })
          .join('')
      : options.items;
  ...
  var ui = {
    ...
    button: function($node, options) {
      return renderer.create('<button type="button" class="note-btn btn btn-default btn-sm" tabindex="-1">', function(
        $node,
        options
      ) {
        ...
        switch (currentCell.action) {
          ...
          case TableResultAction.resultAction.SumSpanCount:
            if (position === 'top') {
              ...
              if (isTopFromRowSpan) {
                var newTd = $('<div></div>')
                  .append($('<td' + tdAttributes + '>' + dom.blank + '</td>').removeAttr('rowspan'))
                  .html();
                html.append(newTd);
                break;
              }
      ...
      var body =
        ...
        (!options.disableLinkTarget
          ? $('<div/>')
              .append(
                ui
                  .checkbox({ id: 'sn-checkbox-open-in-new-window', text: lang.link.openInNewWindow, checked: true })
                  .render()
              )
              .html()
          : '');
  ...
  var ImageDialog = function(context) {
    ...
    this.initialize = function() {
      ...
      if (options.maximumImageFileSize) {
        ...
        var readableSize =
          (options.maximumImageFileSize / Math.pow(1024, unit)).toFixed(2) * 1 + ' ' + ' KMGTP'[unit] + 'B';
