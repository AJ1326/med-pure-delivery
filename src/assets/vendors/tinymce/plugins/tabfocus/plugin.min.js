        ...
        a.add('tabfocus', function(a) {
          ...
          function h(b) {
            function g(e) {
              ...
              function g(a) {
                return /INPUT|TEXTAREA|BUTTON/.test(a.tagName) && d.get(b.id) && a.tabIndex != -1 && f(a);
              }
              if (
            ...
            var h, j, k, l;
            if (
              !(9 !== b.keyCode || b.ctrlKey || b.altKey || b.metaKey || b.isDefaultPrevented()) &&
              ((k = c.explode(a.getParam('tab_focus', a.getParam('tabfocus_elements', ':prev,:next')))),
              1 == k.length && ((k[1] = k[0]), (k[0] = ':prev')),
              (j = b.shiftKey ? (':prev' == k[0] ? g(-1) : i.get(k[0])) : ':next' == k[1] ? g(1) : i.get(k[1])))
            ) {
