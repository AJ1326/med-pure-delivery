        ...
        a.add('colorpicker', function(a) {
          function c(c, d) {
            function e(a) {
              var c = new b(a),
                d = c.toRgb();
              g.fromJSON({ r: d.r, g: d.g, b: d.b, hex: c.toHex().substr(1) }), f(c.toHex());
            }
            function f(a) {
                      ...
                      onchange: function() {
                        ...
                        return (
                          ...
                          'hex' == a
                            ...
                            : ((b = { r: g.find('#r').value(), g: g.find('#g').value(), b: g.find('#b').value() }),
                              c.value(b),
                              void e(b))
                        );
                      }
          ...
          a.settings.color_picker_callback || (a.settings.color_picker_callback = c);
        }),
        function() {}
      );
    }),
