        ...
        a.add('preview', function(a) {
          ...
          a.addCommand('mcePreview', function() {
            a.windowManager.open({
              ...
              html:
                '<iframe src="javascript:\'\'" frameborder="0"' + (e ? ' sandbox="allow-scripts"' : '') + '></iframe>',
              buttons: {
                text: 'Close',
                onclick: function() {
                  this.parent()
              ...
              onPostRender: function() {
                ...
                (f += '<base href="' + g(a.documentBaseURI.getURI()) + '">'),
                  c.each(a.contentCSS, function(b) {
                    f += '<link type="text/css" rel="stylesheet" href="' + g(a.documentBaseURI.toAbsolute(b)) + '">';
                  });
                var h = d.body_id || 'tinymce';
                h.indexOf('=') != -1 && ((h = a.getParam('body_id', '', 'hash')), (h = h[a.id] || h));
                var i = d.body_class || '';
                i.indexOf('=') != -1 && ((i = a.getParam('body_class', '', 'hash')), (i = i[a.id] || ''));
                var j =
                  ...
                  k = a.settings.directionality ? ' dir="' + a.settings.directionality + '"' : '';
                if (
                  ((b =
                  ...
                  this.getEl('body').firstChild.src = 'data:text/html;charset=utf-8,' + encodeURIComponent(b);
                else {
            ...
            a.addMenuItem('preview', { text: 'Preview', cmd: 'mcePreview', context: 'view' });
        }),
        function() {}
      );
    }),
