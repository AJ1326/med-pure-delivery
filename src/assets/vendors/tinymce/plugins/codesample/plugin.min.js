!(function() {
  ...
  h('6', tinymce.util.Tools.resolve),
                  ...
                  for (var e in a)
                    a.hasOwnProperty(e) &&
                      ...
                      'Object' === c.util.type(a[e])
                        ...
                        : 'Array' === c.util.type(a[e]) && c.languages.DFS(a[e], b, e));
                }
              },
              plugins: {},
              ...
              highlightElement: function(d, e, f) {
                ...
                i && ((g = (i.className.match(a) || [, ''])[1]), (h = c.languages[g])),
                  ...
                  /pre/i.test(i.nodeName) &&
                    (i.className = i.className.replace(a, '').replace(/\s+/g, ' ') + ' language-' + g);
                var j = d.textContent,
                ...
                if ((c.hooks.run('before-highlight', k), e && b.Worker)) {
                  ...
                  (k.highlightedCode = c.highlight(k.code, k.grammar, k.language)),
                    c.hooks.run('before-insert', k),
                    (k.element.innerHTML = k.highlightedCode),
                    f && f.call(d),
                    c.hooks.run('after-highlight', k),
      ...
      return (
        ...
        c.languages.markup &&
          (c.hooks.add('before-highlight', function(a) {
            'php' === a.language &&
              ((a.tokenStack = []),
              (a.backupCode = a.code),
              (a.code = a.code.replace(/(?:<\?php|<\?)[\w\W]*?(?:\?>)/gi, function(b) {
          ...
          c.hooks.add('wrap', function(a) {
            'php' === a.language &&
              'markup' === a.type &&
              (a.content = a.content.replace(/(\{\{\{PHP[0-9]+\}\}\})/g, '<span class="token php">$1</span>'));
          }),
        ...
        (function(a) {
          ...
          a.languages.insertBefore('ruby', 'keyword', {
            regex: [
              { pattern: /%r([^a-zA-Z0-9\s\{\(\[<])(?:[^\\]|\\[\s\S])*?\1[gim]{0,3}/, inside: { interpolation: b } },
              { pattern: /%r\((?:[^()\\]|\\[\s\S])*\)[gim]{0,3}/, inside: { interpolation: b } },
              { pattern: /%r\{(?:[^#{}\\]|#(?:\{[^}]+\})?|\\[\s\S])*\}[gim]{0,3}/, inside: { interpolation: b } },
              { pattern: /%r\[(?:[^\[\]\\]|\\[\s\S])*\][gim]{0,3}/, inside: { interpolation: b } },
              { pattern: /%r<(?:[^<>\\]|\\[\s\S])*>[gim]{0,3}/, inside: { interpolation: b } },
              { pattern: /(^|[^\/])\/(?!\/)(\[.+?]|\\.|[^\/\r\n])+\/[gim]{0,3}(?=\s*($|[\r\n,.;})]))/, lookbehind: !0 }
            ...
            (a.languages.ruby.string = [
              { pattern: /%[qQiIwWxs]?([^a-zA-Z0-9\s\{\(\[<])(?:[^\\]|\\[\s\S])*?\1/, inside: { interpolation: b } },
              { pattern: /%[qQiIwWxs]?\((?:[^()\\]|\\[\s\S])*\)/, inside: { interpolation: b } },
              { pattern: /%[qQiIwWxs]?\{(?:[^#{}\\]|#(?:\{[^}]+\})?|\\[\s\S])*\}/, inside: { interpolation: b } },
              { pattern: /%[qQiIwWxs]?\[(?:[^\[\]\\]|\\[\s\S])*\]/, inside: { interpolation: b } },
              { pattern: /%[qQiIwWxs]?<(?:[^<>\\]|\\[\s\S])*>/, inside: { interpolation: b } },
    ...
    g('5', [], function() {
      function a(a) {
        return a && 'PRE' == a.nodeName && a.className.indexOf('language-') !== -1;
      }
      function b(a) {
        return function(b, c) {
          return a(c);
        ...
        a.undoManager.transact(function() {
          ...
          (d = i.encode(d)),
            e
              ...
              : (a.insertContent('<pre id="__new" class="language-' + c + '">' + d + '</pre>'),
      ...
      return {
        open: function(a) {
          a.windowManager.open({
            ...
            minWidth: Math.min(i.getViewPort().w, a.getParam('codesample_dialog_width', 800)),
            minHeight: Math.min(i.getViewPort().h, a.getParam('codesample_dialog_height', 650)),
            layout: 'flex',
            direction: 'column',
            align: 'stretch',
            body: [
              { type: 'listbox', name: 'language', label: 'Language', maxWidth: 200, value: h(a), values: d(a) },
              {
                type: 'textbox',
                name: 'code',
                multiline: !0,
        ...
        b.add('codesample', function(b, h) {
          function i() {
            ...
            (b.inline && f) ||
              ...
              (b.inline ? (f = !0) : (j = !0),
              c !== !1 &&
                ((a = b.dom.create('link', { rel: 'stylesheet', href: c ? c : h + '/css/prism.css' })),
                b
                  .getDoc()
          ...
          a.ceFalse &&
            ...
            b.addCommand('codesample', function() {
              ...
              b.selection.isCollapsed() || e.isCodeSample(a) ? d.open(b) : b.formatter.toggle('code');
            }),
            b.addButton('codesample', { cmd: 'codesample', title: 'Insert/Edit code sample' }),
            b.on('init', i));
        }),
        function() {}
      );
