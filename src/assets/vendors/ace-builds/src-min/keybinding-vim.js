define('ace/keyboard/vim', [
  ...
  function N(e, t) {
    this == v.keyMap.vim && v.rmClass(e.getWrapperElement(), 'cm-fat-cursor'), (!t || t.attach != C) && T(e);
  }
  function C(e, t) {
  ...
  function Mt(e, t) {
    return (
      arguments.length > 2 && (t = Mt.apply(undefined, Array.prototype.slice.call(arguments, 1))), Ot(e, t) ? e : t
    );
  }
  function _t(e, t) {
    return (
      arguments.length > 2 && (t = _t.apply(undefined, Array.prototype.slice.call(arguments, 1))), Ot(e, t) ? t : e
    );
  }
  function Dt(e, t, n) {
    var r = Ot(e, t),
  ...
  function vn(e, t, n, r, i) {
    e.openDialog
      ? e.openDialog(t, r, {
          ...
          selectValueOnOpen: !1,
          onClose: function() {
            (e.state.vim.status = ''), e.ace.renderer.$loop.schedule(e.ace.renderer.CHANGE_CURSOR);
          }
        })
      : r(prompt(n, ''));
  }
  ...
  function Un(e, t, n, r, i, s, o, u, a) {
    ...
    An(e, { prefix: 'replace with <strong>' + u + '</strong> (y/n/a/q/l)', onKeyDown: m });
  }
  function zn(e) {
    var t = e.state.vim,
      n = nt.macroModeState,
      ...
      o = [];
    if (!i) {
      var u = s.inVisualBlock && t.lastSelection ? t.lastSelection.visualBlock.height : 1,
        a = s.changes,
        o = [],
        f = 0;
      while (f < a.length) o.push(a[f]), a[f] instanceof er ? f++ : (f += u);
      (s.changes = o), e.off('change', Qn), v.off(e.getInputField(), 'keydown', tr);
    }
    !i &&
      t.insertModeRepeat > 1 &&
      (nr(e, t, t.insertModeRepeat - 1, !0), (t.lastEditInputState.repeatOverride = t.insertModeRepeat)),
  ...
  function Vn(e, t, n, r) {
    ...
    if (r == ':') {
      i.keyBuffer[0] && Rn.processCommand(e, i.keyBuffer[0]), (n.isPlaying = !1);
      return;
    }
    var s = i.keyBuffer,
      o = 0;
    ...
    for (var u = 0; u < s.length; u++) {
      ...
      while (a) {
        ...
        if (t.insertMode) {
          ...
          (nt.macroModeState.lastInsertModeChanges.changes = c), rr(e, c, 1), zn(e);
        }
      }
    }
    n.isPlaying = !1;
      ...
      while (t) {
        ...
        if (t.origin == '+input' || t.origin == 'paste' || t.origin === undefined) {
          ...
          r.maybeReset && ((r.changes = []), (r.maybeReset = !1)),
            e.state.overwrite && !/\n/.test(i) ? r.changes.push([i]) : r.changes.push(i);
        }
        t = t.next;
      }
  }
  ...
  function tr(e) {
    function i() {
      return n.maybeReset && ((n.changes = []), (n.maybeReset = !1)), n.changes.push(new er(r)), !0;
    }
  ...
  function sr(e, t, n) {
    t.length > 1 && t[0] == 'n' && (t = t.replace('numpad', '')), (t = ir[t] || t);
    var r = '';
    return (
      n.ctrlKey && (r += 'C-'),
      n.altKey && (r += 'A-'),
  ...
  function ur(e) {
    ...
    return (
      Object.keys(e).forEach(function(n) {
        var r = e[n];
        Array.isArray(r) ? (r = r.slice()) : r && typeof r == 'object' && r.constructor != Object && (r = ur(r)),
          (t[n] = r);
      }),
    ...
    (function() {
      ...
      v.defineExtension('openDialog', function(n, r, i) {
        ...
        var s = e(this, n, i.bottom),
          ...
          l;
        if (f)
          i.value && ((f.value = i.value), i.selectValueOnOpen !== !1 && f.select()),
            i.onInput &&
  ...
  var nt,
    ...
    st = {
      ...
      defineEx: function(e, t, n) {
        ...
        (qn[e] = n), (Rn.commandMap_[t] = { name: e, shortName: t, type: 'api' });
      },
      ...
      findKey: function(e, t, n) {
        ...
        function s() {
          if (t == '<Esc>') return ut(e), r.visualMode ? $t(e) : r.insertMode && zn(e), !0;
        }
        function o(n) {
          var r;
          while (n)
  ...
  var ht = {
        ...
        function l(t, n, i) {
          ...
          s == 'Up' || s == 'Down'
            ? ((o = s == 'Up' ? !0 : !1),
              ...
              i(n),
              a && t.target && (t.target.selectionEnd = t.target.selectionStart = Math.min(a, t.target.value.length)))
            : s != 'Left' &&
              s != 'Right' &&
              s != 'Ctrl' &&
              s != 'Alt' &&
          ...
          f ? e.scrollIntoView(Pn(e, !r, f), 30) : (Hn(e), e.scrollTo(u.left, u.top));
        }
        function c(t, n, r) {
          var i = v.keyName(t);
        ...
        switch (n.searchArgs.querySrc) {
          case 'prompt':
            ...
            if (h.isPlaying) {
              ...
              a(p, !0, !1);
            } else An(e, { onClose: f, prefix: s, desc: Ln, onKeyUp: l, onKeyDown: c });
            break;
      ...
      processEx: function(e, t, n) {
        function r(t) {
          nt.exCommandHistoryController.pushInput(t), nt.exCommandHistoryController.reset(), Rn.processCommand(e, t);
        }
        function i(t, n, r) {
          var i = v.keyName(t),
            s,
          ...
          i == 'Up' || i == 'Down'
            ? (v.e_stop(t),
              ...
              r(n),
              o && t.target && (t.target.selectionEnd = t.target.selectionStart = Math.min(o, t.target.value.length)))
            : i == 'Ctrl-U'
            ? (v.e_stop(t), r(''))
            : i != 'Left' &&
              i != 'Right' &&
        ...
        n.type == 'keyToEx'
          ...
          : t.visualMode
          ? An(e, { onClose: r, prefix: ':', value: "'<,'>", onKeyDown: i, selectValueOnOpen: !1 })
    ...
    pt = {
      ...
      goToMark: function(e, t, n, r) {
        ...
        return i ? (n.linewise ? { line: i.line, ch: Qt(e.getLine(i.line)) } : i) : null;
      },
    ...
    mt = {
      change: function(e, t, n) {
        ...
        if (!s.visualMode) {
          ...
          u.line > e.lastLine() && t.linewise && !c ? e.replaceRange('', l, u) : e.replaceRange('', o, u),
            t.linewise && (c || (e.setCursor(l), v.commands.newlineAndIndent(e)), (o.ch = Number.MAX_VALUE)),
            (r = o);
        } else {
          i = e.getSelection();
          var h = vt('', n.length);
      ...
      delete: function(e, t, n) {
        ...
        nt.registerController.pushText(t.registerName, 'delete', i, t.linewise, s.visualBlock);
        var f = s.insertMode;
        return wt(e, r, f);
      },
    ...
    yt = {
      ...
      enterMacroRecordMode: function(e, t) {
        ...
        nt.registerController.isValidRegister(r) && n.enterMacroRecordMode(e, r);
      },
        ...
        e.setOption('disableInput', !1),
          t && t.replace
            ...
            : (e.toggleOverwrite(!1),
              e.setOption('keyMap', 'vim-insert'),
              v.signal(e, 'vim-mode-change', { mode: 'insert' })),
          nt.macroModeState.isPlaying || (e.on('change', Qn), v.on(e.getInputField(), 'keydown', tr)),
          n.visualMode && $t(e),
          It(e, s, o);
      },
  ...
  var qn = {
      ...
      sort: function(e, t) {
        ...
        function S(e, t) {
          ...
          var o = s && d.exec(e),
            u = s && d.exec(t);
          return o
            ? ((o = parseInt((o[1] + o[2]).toLowerCase(), m)), (u = parseInt((u[1] + u[2]).toLowerCase(), m)), o - u)
            : e < t
            ? -1
            : 1;
        }
      ...
      substitute: function(e, t) {
        ...
        if (r.length)
          (i = r[0]),
            (s = r[1]),
            i && i[i.length - 1] === '$' && ((i = i.slice(0, i.length - 1) + '\\n'), (s = s ? s + '\n' : '\n')),
            s !== undefined && (G('pcre') ? (s = Tn(s)) : (s = Sn(s)), (nt.lastSubstituteReplacePart = s)),
            (o = r[2] ? r[2].split(' ') : []);
        else if (n && n.length) {
  ...
  t.handler = {
    ...
    handleKeyboard: function(e, t, n, r, i) {
      ...
      u.insertMode ||
        (t == -1
          ? (n.charCodeAt(0) > 255 && e.inputKey && ((n = e.inputKey), n && e.inputHash == 4 && (n = n.toUpperCase())),
            (e.inputChar = n))
          : t == 4 || t == 0
      ...
      if (t == -1 || t & 1 || (t === 0 && n.length > 1)) {
        ...
        var p = ar(o, h, 'user');
        (u = fr(o)),
          p && u.status != null ? (u.status += h) : u.status == null && (u.status = ''),
    ...
    attach: function(e) {
      ...
      (e.state.cm = t),
        ...
        t.on('vim-command-done', function() {
          ...
          (fr(t).status = null), t.ace._signal('changeStatus'), t.ace.session.markUndoGroup();
        }),
  ...
  S.defineOption(
    ...
    (yt.aceCommand = function(e, t, n) {
      (e.vimCmd = t), e.ace.inVirtualSelectionMode ? e.ace.on('beforeEndOperation', cr) : cr(null, e.ace);
    }),
