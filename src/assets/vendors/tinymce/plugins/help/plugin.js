...
jsc*/
  ...
  define('tinymce.plugins.help.data.KeyboardShortcuts', ['tinymce.core.Env'], function(Env) {
  ...
  define('ephox.katamari.api.Obj', ['ephox.katamari.api.Option', 'global!Object'], function(Option, Object) {
  ...
  define('ephox.katamari.str.StringParts', ['ephox.katamari.api.Option', 'global!Error'], function(Option, Error) {
...
-     */
  ...
  define('tinymce.plugins.help.ui.PluginsTab', [
    ...
    var pluginLister = function(editor) {
      ...
      return '<p><b>Plugins installed (' + count + '):</b></p>' + '<ul>' + pluginsString + '</ul>';
    };
  ...
  define('tinymce.plugins.help.ui.ButtonsRow', ['tinymce.core.EditorManager'], function(EditorManager) {
    ...
    var makeRow = function() {
      ...
      var changeLogLink =
        '<a href="https://www.tinymce.com/docs/changelog/" target="_blank">TinyMCE ' + version + '</a>';
    ...
    var openDialog = function(editor, url) {
      return function() {
        editor.windowManager.open({
          ...
          bodyType: 'tabpanel',
          layout: 'flex',
          body: [KeyboardShortcutsTab.makeTab(), PluginsTab.makeTab(editor, url)],
  ...
  define('tinymce.plugins.help.Plugin', ['tinymce.core.PluginManager', 'tinymce.plugins.help.ui.Dialog'], function(
    PluginManager,
    Dialog
  ) {
