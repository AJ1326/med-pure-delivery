    ...
    g('0', ['1', '2'], function(a, b) {
      return (
        b.add('anchor', function(b) {
          var c = function(a) {
              return !a.attr('href') && (a.attr('id') || a.attr('name')) && !a.firstChild;
            },
            d = function(a) {
              return function(b) {
                for (var d = 0; d < b.length; d++) c(b[d]) && b[d].attr('contenteditable', a);
              };
            },
            e = function(a) {
            ...
            f = function() {
              ...
              c && (d = a.id || a.name || ''),
                b.windowManager.open({
                  title: 'Anchor',
                  body: { type: 'textbox', name: 'id', size: 40, label: 'Id', value: d },
                  onsubmit: function(d) {
                    var f = d.data.id;
                    return e(f)
                      ? void (c
                          ...
                          : (b.selection.collapse(!0),
                            b.execCommand('mceInsertContent', !1, b.dom.createHTML('a', { id: f }))))
                      : (d.preventDefault(),
          ...
          a.ceFalse &&
            b.on('PreInit', function() {
              b.parser.addNodeFilter('a', d('false')), b.serializer.addNodeFilter('a', d(null));
            }),
            b.addCommand('mceAnchor', f),
            b.addButton('anchor', { icon: 'anchor', tooltip: 'Anchor', onclick: f, stateSelector: 'a:not([href])' }),
            b.addMenuItem('anchor', { icon: 'anchor', text: 'Anchor', context: 'insert', onclick: f });
        }),
        function() {}
      );
    }),
