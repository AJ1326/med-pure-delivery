...
jsc*/
  ...
  define('tinymce.plugins.lists.core.TextBlock', ['tinymce.core.dom.DOMUtils', 'tinymce.core.Env'], function(
    DOMUtils,
    Env
  ) {
    var DOM = DOMUtils.DOM;
  ...
  define('tinymce.core.dom.BookmarkManager', ['global!tinymce.util.Tools.resolve'], function(resolve) {
        ...
        onPostRender: function(e) {
          ...
          editor.on('nodechange', function() {
            ...
            for (var i = 0, l = blocks.length; !disable && i < l; i++) {
              ...
              disable =
                (tag === 'LI' && NodeType.isFirstChild(blocks[i])) || tag === 'UL' || tag === 'OL' || tag === 'DD';
            }
