define('ace/occur', [
  ...
  define('ace/keyboard/emacs', [
    ...
    var f = function(e) {
        e.oldSession && ((e.oldSession.$selectLongWords = u), (e.oldSession.$useEmacsStyleLineStart = a)),
          (u = e.session.$selectLongWords),
          (e.session.$selectLongWords = !0),
          (a = e.session.$useEmacsStyleLineStart),
          (e.session.$useEmacsStyleLineStart = !0),
      ...
      t.handler.addCommands({
        ...
        setMark: {
          exec: function(e, t) {
            ...
            if (s && (n || !o)) {
              e.inMultiSelectMode ? e.forEachSelection({ exec: e.clearSelection.bind(e) }) : e.clearSelection(),
        ...
        killLine: function(e) {
          ...
          i && n.end.row != i.end.row && ((n.end.row = i.end.row), (r = 'x')),
            /^\s*$/.test(r) &&
              (n.end.row++, (r = e.session.getLine(n.end.row)), (n.end.column = /^\s*$/.test(r) ? r.length : 0));
