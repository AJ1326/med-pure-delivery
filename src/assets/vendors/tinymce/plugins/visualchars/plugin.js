...
jsc*/
  ...
  define('ephox.sugar.api.node.Node', ['ephox.sugar.api.node.NodeTypes'], function(NodeTypes) {
  ...
  define('tinymce.plugins.visualchars.core.Html', ['tinymce.plugins.visualchars.core.Data'], function(Data) {
