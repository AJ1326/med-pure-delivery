      ...
      return (
        a.add('pagebreak', function(a) {
          var c = 'mce-pagebreak',
            ...
            f = '<img src="' + b.transparentSrc + '" class="' + c + '" data-mce-resize="false" data-mce-placeholder />';
          a.addCommand('mcePageBreak', function() {
            a.settings.pagebreak_split_block ? a.insertContent('<p>' + f + '</p>') : a.insertContent(f);
          }),
            ...
            a.on('ResolveName', function(b) {
              'IMG' == b.target.nodeName && a.dom.hasClass(b.target, c) && (b.name = 'pagebreak');
            }),
            a.on('click', function(b) {
              (b = b.target), 'IMG' === b.nodeName && a.dom.hasClass(b, c) && a.selection.select(b);
            }),
            ...
            a.on('PreInit', function() {
              a.serializer.addNodeFilter('img', function(b) {
                for (var c, e, f = b.length; f--; )
                  if (((c = b[f]), (e = c.attr('class')), e && e.indexOf('mce-pagebreak') !== -1)) {
                    var g = c.parent;
