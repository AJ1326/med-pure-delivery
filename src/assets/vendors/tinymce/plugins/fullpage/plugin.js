...
jsc*/
  ...
  define('tinymce.plugins.fullpage.Protect', ['tinymce.core.util.Tools'], function(Tools) {
    ...
    PluginManager.add('fullpage', function(editor) {
      ...
      function getDefaultHeader() {
        ...
        if (editor.getParam('fullpage_default_xml_pi')) {
          header +=
            '<?xml version="1.0" encoding="' + editor.getParam('fullpage_default_encoding', 'ISO-8859-1') + '" ?>\n';
        }
