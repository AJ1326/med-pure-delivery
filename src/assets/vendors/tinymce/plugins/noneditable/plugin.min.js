      ...
      return (
        a.add('noneditable', function(a) {
          ...
          var e,
            ...
            g,
            h = 'contenteditable';
          (e = ' ' + b.trim(a.getParam('noneditable_editable_class', 'mceEditable')) + ' '),
            (f = ' ' + b.trim(a.getParam('noneditable_noneditable_class', 'mceNonEditable')) + ' ');
          var i = c(e),
            j = c(f);
            ...
            a.on('PreInit', function() {
              g && a.on('BeforeSetContent', d),
                a.parser.addAttributeFilter('class', function(a) {
                  for (var b, c = a.length; c--; ) (b = a[c]), i(b) ? b.attr(h, 'true') : j(b) && b.attr(h, 'false');
                }),
