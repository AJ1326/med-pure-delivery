...
jsc*/
  ...
  define('tinymce.core.AddOnManager', ['global!tinymce.util.Tools.resolve'], function(resolve) {
  ...
  define('tinymce.themes.modern.ui.Branding', ['tinymce.core.dom.DOMUtils'], function(DOMUtils) {
  ...
  define('tinymce.themes.modern.ui.Toolbar', ['tinymce.core.util.Tools', 'tinymce.core.ui.Factory'], function(
    Tools,
    Factory
  ) {
    var defaultToolbar =
        ...
        if (relPos) {
          ...
          if (elementRect) {
            ...
            if (relPos) {
              ...
              movePanelTo(
                panel,
                userConstrain(handler, elementRect.x, elementRect.y, elementRect, contentAreaRect, panelRect)
              );
            }
          } else {
            panel.hide();
  ...
  define('tinymce.themes.modern.ui.Menubar', ['tinymce.core.util.Tools'], function(Tools) {
    var defaultMenus = {
  ...
  define('tinymce.themes.modern.ui.Resize', ['tinymce.core.dom.DOMUtils'], function(DOMUtils) {
    var DOM = DOMUtils.DOM;
      ...
      panel = theme.panel = Factory.create({
        ...
        items: [
          settings.menubar === false
            ? null
            : { type: 'menubar', border: '0 0 1 0', items: Menubar.createMenuButtons(editor) },
  ...
  define('tinymce.core.ui.FloatPanel', ['global!tinymce.util.Tools.resolve'], function(resolve) {
  ...
  define('tinymce.core.ui.Throbber', ['global!tinymce.util.Tools.resolve'], function(resolve) {
  ...
  define('tinymce.themes.modern.ui.ProgressState', ['tinymce.core.ui.Throbber'], function(Throbber) {
