            ...
            a.on('contextmenu', function(b) {
              ...
              if (!j(b)) {
                if (
                  ...
                  b.preventDefault(),
                  (f = a.settings.contextmenu || 'link openlink image inserttable | cell row column deletetable'),
                  c)
                )
                  c.show();
                else {
                  ...
                  e.each(f.split(/[ ,]/), function(b) {
                    var c = a.menuItems[b];
                    '|' == b && (c = { text: b }), c && ((c.shortcut = ''), i.push(c));
                  });
                  for (var k = 0; k < i.length; k++)
                    '|' == i[k].text && ((0 !== k && k != i.length - 1) || i.splice(k, 1));
                  (c = new d({ items: i, context: 'contextmenu', classes: 'contextmenu' }).renderTo()),
                ...
                a.inline || ((l = g.getPos(a.getContentAreaContainer())), (l.x += b.clientX), (l.y += b.clientY)),
                  c.moveTo(l.x, l.y),
                  (h = !0);
              }
            }),
