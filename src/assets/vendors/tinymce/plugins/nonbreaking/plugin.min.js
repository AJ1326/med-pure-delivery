        ...
        a.add('nonbreaking', function(a) {
          ...
          if (
            (a.addCommand('mceNonBreaking', function() {
              a.insertContent(
                a.plugins.visualchars && a.plugins.visualchars.state ? '<span class="mce-nbsp">&nbsp;</span>' : '&nbsp;'
              ),
                a.dom.setAttrib(a.dom.select('span.mce-nbsp'), 'data-mce-bogus', '1');
            }),
            a.addButton('nonbreaking', { title: 'Nonbreaking space', cmd: 'mceNonBreaking' }),
            a.addMenuItem('nonbreaking', { text: 'Nonbreaking space', cmd: 'mceNonBreaking', context: 'insert' }),
            b)
          ) {
            var c = +b > 1 ? +b : 3;
