              ...
              return (
                a.$.each(d.split(' '), function(a, c) {
                  var d = c,
                    e = c,
                    f = c.split('=');
                  f.length > 1 && ((d = f[0]), (e = f[1])), b.push({ text: d, value: e });
                }),
                {
                  type: 'listbox',
                  text: 'Font Sizes',
                  ...
                  onPostRender: function() {
                    ...
                    a.on('NodeChange', function() {
                      var c;
                      (c = a.dom.getParent(a.selection.getNode(), 'font')), c ? b.value(c.size) : b.value('');
                    });
                  },
                  onclick: function(b) {
              ...
              return (
                d.each(f, function(a, b) {
                  e.push({
                    text: { raw: b[0] },
                    value: b[1],
                    textStyle: b[1].indexOf('dings') == -1 ? 'font-family:' + b[1] : ''
                  });
                }),
                {
                  type: 'listbox',
                  ...
                  onPostRender: function() {
                    ...
                    a.on('NodeChange', function() {
                      var c;
                      (c = a.dom.getParent(a.selection.getNode(), 'font')), c ? b.value(c.face) : b.value('');
                    });
                  },
                  onselect: function(b) {
