      ...
      return (
        a.add('insertdatetime', function(a) {
          ...
          var e,
            ...
            h = 'Sunday Monday Tuesday Wednesday Thursday Friday Saturday Sunday'.split(' '),
          ...
          a.addCommand('mceInsertDate', function() {
            ...
            a.addCommand('mceInsertTime', function() {
              d(a.getParam('insertdatetime_timeformat', a.translate('%H:%M:%S')));
            }),
            ...
            b.each(a.settings.insertdatetime_formats || ['%H:%M:%S', '%Y-%m-%d', '%I:%M:%S %p', '%D'], function(a) {
              f || (f = a),
                k.push({
                  text: c(a),
                  onclick: function() {
            ...
            a.addMenuItem('insertdatetime', { icon: 'date', text: 'Date/time', menu: k, context: 'insert' });
        }),
        function() {}
      );
    }),
