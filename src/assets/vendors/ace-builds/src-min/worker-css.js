                ...
                _term: function(e) {
                  ...
                  return (
                    ...
                    t.peek() == Tokens.IE_FUNCTION && this.options.ieFilters
                      ? ((r = this._ie_function()), n === null && ((o = t.token().startLine), (u = t.token().startCol)))
                          ...
                          ? (n === null && ((o = t.LT(1).startLine), (u = t.LT(1).startCol)),
                            r === null &&
                              (t.LA(3) == Tokens.EQUALS && this.options.ieFilters
                                ? (r = this._ie_function())
                                : (r = this._function())))
                          : ((r = s.value), n === null && ((o = s.startLine), (u = s.startCol)))),
            ...
            return (
              isIdentStart(u)
                ? ((s = this.readName(r.read())),
                  (i += s),
                  /^em$|^ex$|^px$|^gd$|^rem$|^vw$|^vh$|^vmax$|^vmin$|^ch$|^cm$|^mm$|^in$|^pt$|^pc$/i.test(s)
                    ? (o = Tokens.LENGTH)
          ...
          complex: {
            ...
            '<flex>': function(e) {
              ...
              if (!n)
                throw ((t = e.peek()),
                new ValidationError(
                  "Expected (none | [ <flex-grow> <flex-shrink>? || <flex-basis> ]) but found '" + e.value.text + "'.",
                  t.line,
                  t.col
                ));
              return n;
        ...
        init: function(e, t) {
          ...
          e.addListener('startfontface', function() {
            ...
            e.addListener('endfontface', function() {
              (r = !1),
                s && t.report("@font-face declaration doesn't follow the fontspring bulletproof syntax.", o, u, n);
            });
        }
      }),
      CSSLint.addRule({
                    ...
                    for (s = 0, o = c.length; s < o; s++)
                      (p = c[s]),
                        CSSLint.Util.indexOf(h, p) === -1 &&
                          ((d = h.length === 1 ? h[0] : h.length === 2 ? h.join(' and ') : h.join(', ')),
                          t.report(
                            'The property ' + p + ' is compatible with ' + d + ' and should be included as well.',
          ...
          function s() {
            r &&
              ...
              (r.selectors
                ...
                : r.propCount === 1 &&
                  t.report("Outlines shouldn't be hidden unless other visual changes are made.", r.line, r.col, n));
          }
          var n = this,
            r;
          e.addListener('startrule', i),
            ...
            e.addListener('property', function(e) {
              ...
              r &&
                (r.propCount++,
                t === 'outline' && (n.toString() === 'none' || n.toString() === '0') && (r.outline = !0));
            }),
              ...
              for (o = 0, a = s.parts.length; o < a; o++)
                for (u = o + 1; u < a; u++)
                  (f = s.parts[o]),
                    ...
                    c === 'descendant' &&
                      p > h &&
                      t.report('newline character found in selector (forgot a comma?)', h, d[r].parts[0].col, n);
            }
          }
          var n = this;
          ...
          function l(e) {
            ...
            for (r in a)
              if (a.hasOwnProperty(r)) {
                ...
                o === a[r].length &&
                  t.report('The properties ' + a[r].join(', ') + ' can be replaced by ' + r + '.', e.line, e.col, n);
              }
          }
          var n = this,
            r,
