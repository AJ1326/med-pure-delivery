...
jsc*/
    ...
    var showDialog = function(editor, linkList) {
      ...
      if (Settings.shouldShowTargetList(editor.settings)) {
        if (Settings.getTargetList(editor.settings) === undefined) {
          Settings.setTargetList(editor, [{ text: 'None', value: '' }, { text: 'New window', value: '_blank' }]);
        }
  ...
  define('tinymce.plugins.link.core.OpenUrl', ['tinymce.core.dom.DOMUtils', 'tinymce.core.Env'], function(
    DOMUtils,
    Env
  ) {
