  ...
  h('7', tinymce.util.Tools.resolve),
      ...
      var a = function(a) {
        ...
        b = function(a, b) {
          for (var c = 0; c < a.length; c++)
            if (0 === b.indexOf(a[c].start) && (!a[c].end || b.lastIndexOf(a[c].end) === b.length - a[c].end.length))
              return a[c];
        },
        c = function(a, b, c, d) {
        ...
        e = function(b, e, f, g) {
          var h,
            i,
            j = a(b);
          for (i = 0; i < j.length; i++) if (((h = j[i]), void 0 !== h.end && c(h, e, f, g) && d(f, g, h))) return h;
        };
    ...
    g('4', ['8', '9', 'a'], function(a, b, c) {
      var d = function(a, b, c, d, e) {
        ...
        f = function(d, e) {
          var f, g, h, i, j, k, l, m, n, o, p;
          if (((f = d.selection), (g = d.dom), f.isCollapsed() && (l = g.getParent(f.getStart(), 'p')))) {
    ...
    g('5', ['3', '4'], function(a, b) {
      function c(a, c) {
        ...
        (e = b.applyInlineFormat(a, c, !1)),
          e &&
            ((d = a.dom.createRng()), d.setStart(e, e.data.length), d.setEnd(e, e.data.length), a.selection.setRng(d)),
        ...
        (d = b.applyInlineFormat(a, c, !0)),
          d &&
            ...
            /[\u00a0 ]/.test(e) &&
              ...
              d.nextSibling ? h.insertAfter(f, d.nextSibling) : d.parentNode.appendChild(f),
              (g = h.createRng()),
              g.setStart(f, 1),
              g.setEnd(f, 1),
