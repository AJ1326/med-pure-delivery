...
@Component({
  selector: 'app-salesman-header',
  templateUrl: './salesmanheader.component.html',
  styleUrls: ['./salesmanheader.component.scss']
})
export class SalesmanheaderComponent implements OnInit, OnChanges {
  menuHidden = true;
  user_info: any;
