...
jsc*/
   ...
   * @private
   */
  define('tinymce.plugins.pagebreak.Plugin', ['tinymce.core.PluginManager', 'tinymce.core.Env'], function(
    PluginManager,
    Env
  ) {
    PluginManager.add('pagebreak', function(editor) {
      var pageBreakClass = 'mce-pagebreak',
        separatorHtml = editor.getParam('pagebreak_separator', '<!-- pagebreak -->');
